...
namespace NetSteps.Accounts.Downline.Service.Hierarchy
{
	...
	{
		/// <summary>
		/// Filters a sequence of <see cref="E.SponsorHierarchy"/> values within the hierarchy
		...
		public static IQueryable<E.SponsorHierarchy> WhereInHierarchy(this IQueryable<E.SponsorHierarchy> source, int rootAccountId, int? maxLevels = null)
		{
			...
			Contract.Ensures(Contract.Result<IQueryable<E.SponsorHierarchy>>() != null);
		...
		/// Note: If this service is used, then this method should be moved to NetSteps.Accounts.Downline.Common. - Lundy
		/// </summary>
		...
		/// <param name="childCollectionSelector"></param>
		/// <returns></returns>
