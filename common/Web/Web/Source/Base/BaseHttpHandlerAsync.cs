...
namespace NetSteps.Web.Base
{
    ...
    /// Created: 04-22-2010
    /// </summary>
    public abstract class BaseHttpHandlerAsync : IHttpAsyncHandler
    {
        #region Members
        ...
        {
            // TODO: Finish converting this to Async by moving all the instance props of this and inheriting handler are in an object 
            //  that is passed into the HttpAsynchOperation so that this can be marked IsReusable = true - JHE

            //context.Response.Write("<p>Begin IsThreadPoolThread is " + Thread.CurrentThread.IsThreadPoolThread + "</p>\r\n");

            HttpAsynchOperation asynch = new HttpAsynchOperation(cb, context, extraData, ProcessRequestAsync);
