...
namespace NetSteps.Modules.DisbursementHold.Tests
{
    ...
    public class DisbursementHoldTests
    {
        ...
        public void SaveDisbursementHold_Returns_New_ICheckHoldResult()
        {
            ...
            var adapter = new DefaultDisbursementHold(checkHoldRepository.Object, termTranslation.Object);
