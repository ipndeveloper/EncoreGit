...
namespace NetSteps.Web.API.Base.Common
{
	public sealed class ValidationErrorCollector
	{
		...
		{
			Contract.Requires<ArgumentNullException>(ietfLanguageTag != null, string.Empty /*Resources.Chk_CannotBeNull*/);
			Contract.Requires<ArgumentException>(ietfLanguageTag.Length > 0, string.Empty /*Resources.Chk_CannotBeEmpty*/);
			Contract.Requires<ArgumentNullException>(lookup != null, string.Empty /*Resources.Chk_CannotBeNull*/);
		...
		{
			Contract.Requires<ArgumentNullException>(item != null, string.Empty /*Resources.Chk_CannotBeNull*/);
			Contract.Requires<ArgumentException>(item.Length > 0, string.Empty /*Resources.Chk_CannotBeEmpty*/);
