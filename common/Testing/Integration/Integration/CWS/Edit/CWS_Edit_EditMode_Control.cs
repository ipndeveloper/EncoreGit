...
{
    public class CWS_Edit_EditMode_Control : Control<UnorderedList>
    {
        ...
        public TPage ClickSwitchToLiveMode<TPage>(int? timeout = null, bool pageRequired = true) where TPage : CWS_Base_Page, new()
        {
