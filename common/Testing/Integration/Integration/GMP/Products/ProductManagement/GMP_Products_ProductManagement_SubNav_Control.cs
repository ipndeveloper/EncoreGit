...
{
    public class GMP_Products_ProductManagement_SubNav_Control : Control<Div>
    {
        ...
        {
            Element.CustomRunScript(Util.strSlideDown, null, 1);
            timeout = Element.GetElement<Link>(new Param("/Products/Products/Create", AttributeName.ID.Href, RegexOptions.None)).CustomClick(timeout);
