...
{
    public class GMP_Reports_MonthlyBonusesByTitle_Page : GMP_Reports_Viewer_Page
    {
        ...
        protected override void InitializeContents()
        {
            ...
            _titleType = Document.SelectList("rptViewer_ctl04_ctl03_ddValue");
            _period = Document.SelectList("rptViewer_ctl04_ctl07_ddValue");
            if (_period.Exists)
            {
                _plan = Document.SelectList("rptViewer_ctl04_ctl05_ddValue");
            }
            else
            {
