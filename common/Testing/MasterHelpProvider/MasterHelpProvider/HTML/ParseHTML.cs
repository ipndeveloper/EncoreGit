...
namespace TestMasterHelpProvider.HTML
{

    //TestMasterHelpProvider.HTML.ParseHTML parse = new TestMasterHelpProvider.HTML.ParseHTML();
    //parse.Source = Utils.ReadFile("C:\\TestImage\\Invitation.html");
    //while (!parse.Eof())
    //{
    //    char ch = parse.Parse();
    //    if (ch == 0)
    //    {
    //        TestMasterHelpProvider.HTML.AttributeList tag = parse.GetTag();
    //        if (tag["href"] != null)
