...
namespace NetSteps.Auth.Service.Test.Providers
{
	...
	public class UsernameAuthenticationProviderTest
	{
		...
		[TestMethod]
		public void UsernameAuthenticationProvider_should_authenticate_successfully()
		{
			var username = "123";
			...
			var provider = new UsernameAuthenticationProvider(() => { return store.Object; });
		...
		[TestMethod]
		public void UsernameAuthenticationProvider_should_fail_authentication_gracefully()
		{
			var username = "123";
			var password = "I'm A Big Test Password";
