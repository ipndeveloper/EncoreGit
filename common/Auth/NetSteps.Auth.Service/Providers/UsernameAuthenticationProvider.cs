...
{
	public class UsernameAuthenticationProvider : BaseAuthenticationProvider, IAuthenticationProvider
	{
		private AuthenticationStoreField _storeField = AuthenticationStoreField.Username;

		public UsernameAuthenticationProvider(Func<IAuthenticationStore> storeConstructor) : base(storeConstructor)
		{
		}

		public override string GetProviderName()
		{
			return EncoreAuthenticationProviderNames.UsernameProvider;
		}
