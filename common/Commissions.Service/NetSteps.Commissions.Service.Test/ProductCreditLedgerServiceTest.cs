...
{
	[TestClass]
	public class ProductCreditLedgerServiceTest
	{
		private ProductCreditLedgerService GetLedgerService()
		{
			return new ProductCreditLedgerService
				(
					new ProductCreditLedgerEntryService
						(
							new ProductCreditLedgerEntryProvider(new ProductCreditLedgerEntryRepository(
		...
		[TestMethod]
		public void ProductCreditLedgerService_should_GetLedgerEntryKind_by_LedgerEntryKindId()
		{
		...
		[TestMethod]
		public void ProductCreditLedgerService_should_GetLedgerEntryKind_by_LedgerEntryKindCode()
		{
		...
		[TestMethod]
		public void ProductCreditLedgerService_should_AddLedgerEntry()
		{
			using (var scope = new TransactionScope())
			{
				IProductCreditLedgerEntry ledgerEntry = new ProductCreditLedgerEntry()
				{
					AccountId = 1,
					BonusTypeId = 7,
					BonusValueId = null,
		...
		[TestMethod]
		public void ProductCreditLedgerService_should_AddLedgerEntryByValues()
		{
			using (var scope = new TransactionScope())
			{
				var ledgerService = GetLedgerService();
		...
		[TestMethod]
		public void ProductCreditLedgerService_should_GetCurrentBalance()
		{
			using (var scope = new TransactionScope())
			{
				IProductCreditLedgerEntry dummyLedgerEntry = new ProductCreditLedgerEntry()
				{
					AccountId = 1,
					BonusTypeId = 7,
					BonusValueId = null,
		...
		[TestMethod]
		public void ProductCreditLedgerService_should_GetCurrentBalanceLessPendingPayments()
		{
            Assert.Inconclusive();
        }

		[TestMethod]
		public void ProductCreditLedgerService_should_GetEntryOrigin()
		{
			var entryOriginId = 2;
			...
			Assert.AreEqual("System - Commission Engine", origin.Name);
			Assert.AreEqual("SystemCommissionEngine", origin.TermName);
			Assert.AreEqual("CE", origin.Code);
			Assert.IsTrue(origin.IsEnabled);
			Assert.IsFalse(origin.IsEditable);
		}

		[TestMethod]
		public void ProductCreditLedgerService_should_GetEntryOrigins()
		{
			var ledgerService = GetLedgerService();
		...
		[TestMethod]
		public void ProductCreditLedgerService_should_GetEntryReason()
		{
			var entryReasonId = 5;
			...
			Assert.AreEqual("Credit Redemption", reason.Name);
			Assert.AreEqual("CreditRedemption", reason.TermName);
			Assert.AreEqual("CR", reason.Code);
			Assert.IsTrue(reason.IsEnabled);
			Assert.IsFalse(reason.IsEditable);
		}

		[TestMethod]
		public void ProductCreditLedgerService_should_RetrieveLedger()
		{
			using (var scope = new TransactionScope())
			{
				IProductCreditLedgerEntry dummyLedgerEntry = new ProductCreditLedgerEntry()
		...
		[TestMethod]
		public void ProductCreditLedgerService_should_GetEntryReasons()
		{
			var ledgerService = GetLedgerService();
		...
		[TestMethod]
		public void ProductCreditLedgerService_should_GetEntryKinds()
		{
