...
namespace NetSteps.Commissions.Common.Services.CalculationOverride
{
	/// <summary>
	/// 
	/// </summary>
	public interface ICalculationOverrideService
	{
		...
		/// <returns></returns>
		IEnumerable<ICalculationOverride> SearchCalculationOverrides(CalculationOverrideSearchParameters parameters);
