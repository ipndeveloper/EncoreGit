...
{
    [ContractClass(typeof(MultipleMarketStandardQualificationPromotionContract))]
    public interface IMultipleMarketStandardQualificationPromotion : IStandardQualificationPromotion
    {
        /// <summary>
        /// Gets the market IDs.
        /// </summary>
        /// <value>The market IDs.</value>
        IEnumerable<int> MarketIDs { get; }

        void AddMarketID(int marketID);

        void DeleteMarketID(int marketID);

    }

    [ContractClassFor(typeof(IMultipleMarketStandardQualificationPromotion))]
    public abstract class MultipleMarketStandardQualificationPromotionContract : IMultipleMarketStandardQualificationPromotion
    {
