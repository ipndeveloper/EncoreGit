	...
	public class ProductPromotionPercentDiscount : MultipleMarketStandardQualificationPromotion, IProductPromotionPercentDiscount
	{
            ...
            set
            {
                if (value)
                {
                    if (!PromotionRewards.ContainsKey(RewardNames.ReducedShipping))
                    {
                        ...
                        reward.DefaultMarketID = DefaultMarketID;

                        reward.OrderAdjustmentOrderOperationID = (int)OrderAdjustmentOrderOperationKind.Multiplier;
                        reward.MarketDecimalOperands.Add(DefaultMarketID, 1);
        ...
        public decimal ReduceSubtotalByPercent
        {
            get
            {
                ...
                {
                    return ((IOrderSubtotalReductionReward)PromotionRewards[RewardNames.ReducedSubtotal]).GetMarketDecimalOperand(DefaultMarketID);
                }
                else
                {
                    return 0M;
            ...
            set
            {
                if (value > 0)
                {
                    if (!PromotionRewards.ContainsKey(RewardNames.ReducedSubtotal))
                    {
                        ...
                        reward.DefaultMarketID = DefaultMarketID;
                        reward.SetMarketDecimalOperand(DefaultMarketID, value);
