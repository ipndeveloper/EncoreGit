...
namespace NetSteps.Common.Validation.NetTiers
{
    ...
    public static class CommonRules
    {
        ...
        {
            PropertyInfo p = target.GetType().GetPropertyCached(e.PropertyName);
            ...
            if (p != null)
            {
                ...
                if (value == null)
                {
                    ...
                    {
                        string customErrorMessage = e.GetCustomErrorMessage(value == null ? string.Empty : value.ToString());
                        if (!string.IsNullOrWhiteSpace(customErrorMessage))
                            e.Description = customErrorMessage;
                        else
                        {
                            string errorMessage = Translation.TermTranslation.GetTerm("NotNullRuleErrorMessage", "{0} can not be null.");
                            e.Description = String.Format(errorMessage, e.PropertyNameTranslated);
                        }
                    }
                    return false;
                }
            ...
            if (p != null)
            {
                ...
                if (string.IsNullOrEmpty(value))
                {
                    if (string.IsNullOrEmpty(e.Description))
                    {
                        ...
                        {
                            string errorMessage = Translation.TermTranslation.GetTerm("StringRequiredRuleErrorMessage", "{0} required");
                            e.Description = String.Format(errorMessage, e.PropertyNameTranslated);
                        }
                    }
                    return false;
        ...
        public static bool StringMaxLength(object target, ValidationRuleArgs e)
        {
            ...
            if (args != null)
            {
                ...
                PropertyInfo p = targetType.GetPropertyCached(e.PropertyName);
                    ...
                    if (p.PropertyType == typeof(string))
                    {
                        ...
                        if (!String.IsNullOrEmpty(value) && (value.Length > max))
                        {
                            if (string.IsNullOrEmpty(e.Description))
                            {
                                ...
                                {
                                    string errorMessage = Translation.TermTranslation.GetTerm("MaxLengthRuleErrorMessage", "{0} can not exceed {1} characters");
                                    e.Description = String.Format(errorMessage, e.PropertyNameTranslated, max.ToString());
                                }
                            }
                            return false;
                        }
        ...
        public static bool MaxWords(object target, ValidationRuleArgs e)
        {
            ...
            string text2 = (string)p.GetValue(target, null);
        ...
        public static bool RegexIsNotMatch(object target, ValidationRuleArgs e)
        {
            if (RegexIsMatch(target, e))
            {
                ...
                if (args != null)
                {
                    ...
                    if (p != null)
                    {
                        ...
                        {
                            string value = (string)p.GetValue(target, null);
                            if (args.IsValidOnNull && string.IsNullOrEmpty(value)) return true;
                            string customErrorMessage = e.GetCustomErrorMessage(value == null ? string.Empty : value.ToString());
                            if (!string.IsNullOrWhiteSpace(customErrorMessage))
                                e.Description = customErrorMessage;
                        }
            ...
            if (args != null)
            {
                ...
                if (p != null)
                {
                    if (p.PropertyType == typeof(string))
                    {
                        ...
                        if (!(args.IsValidOnNull && value == null) && (value == null || !Regex.IsMatch(value, expression)))
                        {
                            if (string.IsNullOrEmpty(e.Description))
                            {
                                string customErrorMessage = e.GetCustomErrorMessage(value == null ? string.Empty : value.ToString());
                                ...
                                {
                                    string errorMessage = Translation.TermTranslation.GetTerm("RegexIsMatchRuleErrorMessage", "'{0}' does not match the regular expression: {1}");
                                    e.Description = string.Format(errorMessage, e.PropertyNameTranslated, expression);
                                }
                            }
                            return false;
                        }
        ...
        public class RegexRuleArgs : ValidationRuleArgs
        {
            ...
            public RegexRuleArgs(
              string propertyName, string expression, string errorMessage)
            ...
            public RegexRuleArgs(
              string propertyName, string expression, string errorMessage, bool isValidOnNull)
                : base(propertyName, errorMessage)
            {
                _expression = expression;
                _isValidOnNull = isValidOnNull;
            }
                    ...
                    case CompareType.LessThanOrEqualTo:
                        ...
                        if (!result)
                        {
                            if (string.IsNullOrEmpty(e.Description))
                            {
                                ...
                                {
                                    string errorMessage = Translation.TermTranslation.GetTerm("LessThanOrEqualToRuleErrorMessage", "{0} can not exceed {1}");
                                    e.Description = String.Format(errorMessage, e.PropertyNameTranslated, compareValue.ToString());
                                }
                            }
                        }
                        break;
                    ...
                    case CompareType.LessThan:
                        ...
                        if (!result)
                        {
                            if (string.IsNullOrEmpty(e.Description))
                            {
                                ...
                                {
                                    string errorMessage = Translation.TermTranslation.GetTerm("LessThanRuleErrorMessage", "{0} must be less than {1}");
                                    e.Description = String.Format(errorMessage, e.PropertyNameTranslated, compareValue.ToString());
                                }
                            }
                        }
                    ...
                    case CompareType.EqualTo:
                        ...
                        if (!result)
                        {
                            if (string.IsNullOrEmpty(e.Description))
                            {
                                ...
                                {
                                    string errorMessage = Translation.TermTranslation.GetTerm("EqualToRuleErrorMessage", "{0} must equal {1}");
                                    e.Description = String.Format(errorMessage, e.PropertyNameTranslated, compareValue.ToString());
                                }
                            }
                        }
                    ...
                    case CompareType.GreaterThan:
                        ...
                        if (!result)
                        {
                            if (string.IsNullOrEmpty(e.Description))
                            {
                                ...
                                {
                                    string errorMessage = Translation.TermTranslation.GetTerm("GreaterThanRuleErrorMessage", "{0} must exceed {1}");
                                    e.Description = String.Format(errorMessage, e.PropertyNameTranslated, compareValue.ToString());
                                }
                            }
                        }
                    ...
                    case CompareType.GreaterThanOrEqualTo:
                        ...
                        if (!result)
                        {
                            if (string.IsNullOrEmpty(e.Description))
                            {
                                ...
                                {
                                    string errorMessage = Translation.TermTranslation.GetTerm("GreaterThanOrEqualToRuleErrorMessage", "{0} must be greater than or equal to {1}");
                                    e.Description = String.Format(errorMessage, e.PropertyNameTranslated, compareValue.ToString());
                                }
                            }
                        }
        ...
        public class CompareValueRuleArgs<T> : ValidationRuleArgs
        {
            ...
            public CompareValueRuleArgs(string propertyName, T compareValue, string errorMessage)
                : base(propertyName, errorMessage)
            {
                _compareValue = compareValue;
            }
            ...
            if (ruleArgs != null)
            {
                ...
                if (!result)
                {
                    if (string.IsNullOrEmpty(e.Description))
                    {
                        ...
                        {
                            string errorMessage = Translation.TermTranslation.GetTerm("InRangeRuleErrorMessage", "{0} must be between {1} and {2}.");
                            e.Description = String.Format(errorMessage, e.PropertyNameTranslated, ruleArgs.Range.MinValue, ruleArgs.Range.MaxValue);
                        }
                    }
                }
        ...
        public class Range<T>
        {
            ...
            public Range(T minValue, T maxValue)
            {
                ...
                if (System.Collections.Comparer.DefaultInvariant.Compare(minValue, maxValue) <= 0)
                {
            ...
            {
                return System.Collections.Comparer.DefaultInvariant.Compare(value, MinValue) >= 0 && System.Collections.Comparer.DefaultInvariant.Compare(value, MaxValue) <= 0;
            }
        ...
        #region ValidDateRange
        /// <summary>
        /// Private method that compares a property value with a specified value.
        /// </summary>
        /// <param name="target">Object containing the data to validate.</param>
        /// <returns></returns>
        public static bool ValidDateRange(object target, ValidationRuleArgs e)
        {
            bool result = true;
            if (target is IDateRange)
            {
                IDateRange dateRange = (IDateRange)target;
                if (!dateRange.StartDate.IsNullOrEmpty() && !dateRange.EndDate.IsNullOrEmpty())
                {
                    if (dateRange.StartDate > dateRange.EndDate)
                    {
                        Type type = target.GetType();
                        string errorMessage = Translation.TermTranslation.GetTerm("EntityTypeStartDateCannotBeGreaterThanEndDateMessage", "{0} - Start Date ({1}) can not exceed End Date ({2})");
                        e.Description = String.Format(errorMessage, type.Name, dateRange.StartDate.ToString(), dateRange.EndDate.ToString());
                        return false;
                    }
                }
            }
