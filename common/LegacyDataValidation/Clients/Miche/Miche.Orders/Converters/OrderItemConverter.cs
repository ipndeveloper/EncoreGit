        ...
        private void EnsureOrderItemPrices(IRecord converted)
        {
            ...
            foreach (var priceType in priceTypes)
            {
                ...
                if (found == null)
                {
                    ...
                    orderItemIDProperty.ExpectedValue = orderItemIDProperty.OriginalValue;
                    ...
                    originalUnitPriceProperty.ExpectedValue = originalUnitPriceProperty.OriginalValue;
                    ...
                    unitPriceProperty.ExpectedValue = unitPriceProperty.OriginalValue;
                    ...
                    productPriceTypeIDProperty.ExpectedValue = productPriceTypeIDProperty.OriginalValue;
