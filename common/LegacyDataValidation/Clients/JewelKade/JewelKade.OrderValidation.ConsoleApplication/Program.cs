...
using JewelKade.Orders.Repository;
...
namespace JewelKade.OrderValidation.ConsoleApplication
{
    class Program
    {
        ...
        private static void runProgram()
        {
            ...
            var query = new SingleOrderQuery(461640);
            //var query = new DateRangeOrderQuery(new DateTime(2013, 6, 1), new DateTime(2013, 7, 1)) { MaximumBufferRecords = 500 };
            ...
            #region Broken SQL logger
            {
                var sqlSerializer = Container.Current.NewNamedWithParams<IRecordValidationSerializer>
                    (
                        ...
                        Param.Named<ValidationCommentKind>("commentTypes", ValidationCommentKind.Errors | ValidationCommentKind.CalculationComment),
