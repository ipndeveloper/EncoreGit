...
{
    public partial class CalculationOverride
    {
        #region Members
        ...
        public static PaginatedList<CalculationOverrideSearchData> Search(CalculationOverrideSearchParameters searchParameters)
        {
            try
            {
