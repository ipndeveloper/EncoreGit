...
{
    [Serializable]
    public class AccountCreditSearchData
    {
        [Sortable(false)]
        ...
        [Sortable(false)]
        [TermName("AccountCreditAsg", "Credit Asig")]
        public string AccountCreditAsg { get; set; }
        [Sortable(false)]
        [TermName("AccountCreditUti", "Credit Util")]
        public string AccountCreditUti { get; set; }
        [Sortable(false)]
        [TermName("AccountCreditDis", "Credit Disponible")]
        public string AccountCreditDis { get; set; }
        [Sortable(false)]
        [TermName("AccountCreditEst", "Credit Estado")]
        public string AccountCreditEst { get; set; }
        [Sortable(false)]
        [TermName("AccountCreditAnt", "Credit Anterior")]
        public string AccountCreditAnt { get; set; }
        [Sortable(false)]
        [TermName("AccountCreditFec", "Credit Date")]
