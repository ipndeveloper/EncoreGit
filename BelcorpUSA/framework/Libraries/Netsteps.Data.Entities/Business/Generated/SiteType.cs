...
{
    public partial class SiteType : EntityBusinessBase<SiteType, Int16, ISiteTypeRepository, ISiteTypeBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public SiteType() : this(default(ISiteTypeRepository), default(ISiteTypeBusinessLogic))
    	{
    	}
    	public SiteType(ISiteTypeRepository repo) : this(repo, default(ISiteTypeBusinessLogic))
    	{
    	}
    	public SiteType(ISiteTypeRepository repo, ISiteTypeBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<SiteType> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<SiteType> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<SiteType> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var siteTypes = Repository.LoadAllFullWithSqlDependency();
    			foreach (var siteType in siteTypes)
    			{
    				siteType.StartTracking();
    				siteType.IsLazyLoadingEnabled = true;
    			}
    			return siteTypes;
    		}
    		catch (Exception ex)
