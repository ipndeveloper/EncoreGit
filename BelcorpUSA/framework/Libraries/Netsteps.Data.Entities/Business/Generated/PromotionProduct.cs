...
{
    public partial class PromotionProduct : EntityBusinessBase<PromotionProduct, Int32, IPromotionProductRepository, IPromotionProductBusinessLogic>, IDatabaseValidationRules
    {
    	...
    	#region Constructors
    	public PromotionProduct() : this(default(IPromotionProductRepository), default(IPromotionProductBusinessLogic))
    	{
    	}
    	public PromotionProduct(IPromotionProductRepository repo) : this(repo, default(IPromotionProductBusinessLogic))
    	{
    	}
    	public PromotionProduct(IPromotionProductRepository repo, IPromotionProductBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
