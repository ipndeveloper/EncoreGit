...
{
    public partial class Market : EntityBusinessBase<Market, Int32, IMarketRepository, IMarketBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public Market() : this(default(IMarketRepository), default(IMarketBusinessLogic))
    	{
    	}
    	public Market(IMarketRepository repo) : this(repo, default(IMarketBusinessLogic))
    	{
    	}
    	public Market(IMarketRepository repo, IMarketBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<Market> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<Market> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var markets = Repository.LoadAllFullWithSqlDependency();
    			foreach (var market in markets)
    			{
    				market.StartTracking();
    				market.IsLazyLoadingEnabled = true;
    			}
    			return markets;
    		}
    		catch (Exception ex)
