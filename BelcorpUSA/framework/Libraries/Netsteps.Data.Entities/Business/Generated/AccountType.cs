...
{
    public partial class AccountType : EntityBusinessBase<AccountType, Int16, IAccountTypeRepository, IAccountTypeBusinessLogic>, IDatabaseValidationRules, ITermName, IActive, ICode
    {
    	...
    	#region Constructors
    	public AccountType() : this(default(IAccountTypeRepository), default(IAccountTypeBusinessLogic))
    	{
    	}
    	public AccountType(IAccountTypeRepository repo) : this(repo, default(IAccountTypeBusinessLogic))
    	{
    	}
    	public AccountType(IAccountTypeRepository repo, IAccountTypeBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	{ 
    		...
    		this.ValidationRules.AddRule(CommonRules.StringMaxLength, new CommonRules.MaxLengthRuleArgs("Code", 25));
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<AccountType> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<AccountType> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var accountTypes = Repository.LoadAllFullWithSqlDependency();
    			foreach (var accountType in accountTypes)
    			{
    				accountType.StartTracking();
    				accountType.IsLazyLoadingEnabled = true;
    			}
    			return accountTypes;
    		}
    		catch (Exception ex)
