...
{
    public partial class ProductProperty : EntityBusinessBase<ProductProperty, Int32, IProductPropertyRepository, IProductPropertyBusinessLogic>, IDatabaseValidationRules, IActive
    {
    	...
    	#region Constructors
    	public ProductProperty() : this(default(IProductPropertyRepository), default(IProductPropertyBusinessLogic))
    	{
    	}
    	public ProductProperty(IProductPropertyRepository repo) : this(repo, default(IProductPropertyBusinessLogic))
    	{
    	}
    	public ProductProperty(IProductPropertyRepository repo, IProductPropertyBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
