...
{
    public partial class SupportTicketStatus : EntityBusinessBase<SupportTicketStatus, Int16, ISupportTicketStatusRepository, ISupportTicketStatusBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public SupportTicketStatus() : this(default(ISupportTicketStatusRepository), default(ISupportTicketStatusBusinessLogic))
    	{
    	}
    	public SupportTicketStatus(ISupportTicketStatusRepository repo) : this(repo, default(ISupportTicketStatusBusinessLogic))
    	{
    	}
    	public SupportTicketStatus(ISupportTicketStatusRepository repo, ISupportTicketStatusBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<SupportTicketStatus> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<SupportTicketStatus> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<SupportTicketStatus> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var supportTicketStatuses = Repository.LoadAllFullWithSqlDependency();
    			foreach (var supportTicketStatus in supportTicketStatuses)
    			{
    				supportTicketStatus.StartTracking();
    				supportTicketStatus.IsLazyLoadingEnabled = true;
    			}
