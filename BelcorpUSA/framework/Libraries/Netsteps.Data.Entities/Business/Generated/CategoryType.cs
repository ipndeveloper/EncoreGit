...
{
    public partial class CategoryType : EntityBusinessBase<CategoryType, Int16, ICategoryTypeRepository, ICategoryTypeBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public CategoryType() : this(default(ICategoryTypeRepository), default(ICategoryTypeBusinessLogic))
    	{
    	}
    	public CategoryType(ICategoryTypeRepository repo) : this(repo, default(ICategoryTypeBusinessLogic))
    	{
    	}
    	public CategoryType(ICategoryTypeRepository repo, ICategoryTypeBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<CategoryType> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<CategoryType> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<CategoryType> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var categoryTypes = Repository.LoadAllFullWithSqlDependency();
    			foreach (var categoryType in categoryTypes)
    			{
    				categoryType.StartTracking();
    				categoryType.IsLazyLoadingEnabled = true;
    			}
