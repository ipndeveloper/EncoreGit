...
{
    public partial class ProductFileType : EntityBusinessBase<ProductFileType, Int32, IProductFileTypeRepository, IProductFileTypeBusinessLogic>, IDatabaseValidationRules, ITermName, IEditable, IActive
    {
    	...
    	#region Constructors
    	public ProductFileType() : this(default(IProductFileTypeRepository), default(IProductFileTypeBusinessLogic))
    	{
    	}
    	public ProductFileType(IProductFileTypeRepository repo) : this(repo, default(IProductFileTypeBusinessLogic))
    	{
    	}
    	public ProductFileType(IProductFileTypeRepository repo, IProductFileTypeBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<ProductFileType> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<ProductFileType> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<ProductFileType> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var productFileTypes = Repository.LoadAllFullWithSqlDependency();
    			foreach (var productFileType in productFileTypes)
    			{
    				productFileType.StartTracking();
    				productFileType.IsLazyLoadingEnabled = true;
    			}
