...
namespace NetSteps.Data.Entities
{
    ...
    [Serializable]
    public partial class CampaignActionType: IObjectWithChangeTracker, INotifyPropertyChanged
    {
    	...
    	public short CampaignActionTypeID
    	{
    		...
    		set
    		{
    			if (_campaignActionTypeID != value)
    			{
    				...
    				{
    					throw new InvalidOperationException("The property 'CampaignActionTypeID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
    				}
    	...
    	private void FixupCampaignActions(object sender, NotifyCollectionChangedEventArgs e)
    	{
    		...
    		if (e.OldItems != null)
    		{
    			...
    			{
    				if (ReferenceEquals(item.CampaignActionType, this))
    				{
    					item.CampaignActionType = null;
    				}
    				if (ChangeTracker.ChangeTrackingEnabled)
    				{
