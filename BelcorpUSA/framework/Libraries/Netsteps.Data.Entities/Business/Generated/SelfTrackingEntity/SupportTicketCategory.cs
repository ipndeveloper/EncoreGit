...
namespace NetSteps.Data.Entities
{
    ...
    [Serializable]
    public partial class SupportTicketCategory: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region Primitive Properties
    	partial void SupportTicketCategoryIDChanged();
    	public short SupportTicketCategoryID
    	{
    		...
    		set
    		{
    			if (_supportTicketCategoryID != value)
    			{
    				...
    				{
    					throw new InvalidOperationException("The property 'SupportTicketCategoryID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
    				}
    	...
    	private short _supportTicketCategoryID;
    	...
    	private void FixupSupportTickets(object sender, NotifyCollectionChangedEventArgs e)
    	{
    		...
    		if (e.NewItems != null)
    		{
    			...
    			{
    				item.SupportTicketCategory = this;
    				if (ChangeTracker.ChangeTrackingEnabled)
    				{
    		...
    		if (e.OldItems != null)
    		{
    			...
    			{
    				if (ReferenceEquals(item.SupportTicketCategory, this))
    				{
    					item.SupportTicketCategory = null;
    				}
    				if (ChangeTracker.ChangeTrackingEnabled)
    				{
