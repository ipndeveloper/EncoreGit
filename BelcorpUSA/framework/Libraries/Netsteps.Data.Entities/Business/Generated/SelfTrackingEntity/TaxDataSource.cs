...
namespace NetSteps.Data.Entities
{
    ...
    [Serializable]
    public partial class TaxDataSource: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region Primitive Properties
    	partial void TaxDataSourceIDChanged();
    	public short TaxDataSourceID
    	{
    		...
    		set
    		{
    			if (_taxDataSourceID != value)
    			{
    				...
    				{
    					throw new InvalidOperationException("The property 'TaxDataSourceID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
    				}
    	...
    	private short _taxDataSourceID;
    	...
    	private void FixupTaxCaches(object sender, NotifyCollectionChangedEventArgs e)
    	{
    		...
    		if (e.OldItems != null)
    		{
    			...
    			{
    				if (ReferenceEquals(item.TaxDataSource, this))
    				{
    					item.TaxDataSource = null;
    				}
    				if (ChangeTracker.ChangeTrackingEnabled)
    				{
