...
namespace NetSteps.Data.Entities
{
    ...
    [Serializable]
    public partial class Gender: IObjectWithChangeTracker, INotifyPropertyChanged
    {
    	...
    	public short GenderID
    	{
    		...
    		set
    		{
    			if (_genderID != value)
    			{
    				...
    				{
    					throw new InvalidOperationException("The property 'GenderID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
    				}
    				_genderID = value;
    				GenderIDChanged();
    	...
    	private void FixupAccounts(object sender, NotifyCollectionChangedEventArgs e)
    	{
    		...
    		if (e.OldItems != null)
    		{
    			...
    			{
    				if (ReferenceEquals(item.Gender, this))
    				{
    					item.Gender = null;
    				}
    				if (ChangeTracker.ChangeTrackingEnabled)
