...
namespace NetSteps.Data.Entities
{
    ...
    [Serializable]
    public partial class ListValueType: IObjectWithChangeTracker, INotifyPropertyChanged
    {
    	...
    	public short ListValueTypeID
    	{
    		...
    		set
    		{
    			if (_listValueTypeID != value)
    			{
    				...
    				{
    					throw new InvalidOperationException("The property 'ListValueTypeID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
    				}
    	...
    	private void FixupAccountListValues(object sender, NotifyCollectionChangedEventArgs e)
    	{
    		...
    		if (e.OldItems != null)
    		{
    			...
    			{
    				if (ReferenceEquals(item.ListValueType, this))
    				{
    					item.ListValueType = null;
    				}
    				if (ChangeTracker.ChangeTrackingEnabled)
    				{
