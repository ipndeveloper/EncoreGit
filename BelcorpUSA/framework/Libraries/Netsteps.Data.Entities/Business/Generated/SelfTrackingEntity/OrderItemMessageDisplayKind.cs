...
{
    [Serializable]
    public partial class OrderItemMessageDisplayKind: IObjectWithChangeTracker, INotifyPropertyChanged
    {
    	...
    	public int OrderItemMessageDisplayKindID
    	{
    		...
    		set
    		{
    			if (_orderItemMessageDisplayKindID != value)
    			{
    				...
    				{
    					throw new InvalidOperationException("The property 'OrderItemMessageDisplayKindID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
    				}
