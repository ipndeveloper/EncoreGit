...
namespace NetSteps.Data.Entities
{
    ...
    [Serializable]
    public partial class AccountSource: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region Primitive Properties
    	partial void AccountSourceIDChanged();
    	public short AccountSourceID
    	{
    		...
    		set
    		{
    			if (_accountSourceID != value)
    			{
    				...
    				{
    					throw new InvalidOperationException("The property 'AccountSourceID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
    				}
    	...
    	private short _accountSourceID;
    	...
    	private void FixupAccounts(object sender, NotifyCollectionChangedEventArgs e)
    	{
    		...
    		if (e.OldItems != null)
    		{
    			...
    			{
    				if (ReferenceEquals(item.AccountSource, this))
    				{
    					item.AccountSource = null;
    				}
    				if (ChangeTracker.ChangeTrackingEnabled)
    				{
