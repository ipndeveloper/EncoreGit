...
namespace NetSteps.Data.Entities
{
    ...
    [Serializable]
    public partial class ProductVariantInfo: IObjectWithChangeTracker, INotifyPropertyChanged
    {
    	...
    	partial void UseMasterPricingChanged();
    	public bool UseMasterPricing
    	{
    		get { return _useMasterPricing; }
    		set
    		{
    			if (_useMasterPricing != value)
    			{
    				ChangeTracker.RecordOriginalValue("UseMasterPricing", _useMasterPricing);
    				_useMasterPricing = value;
    				UseMasterPricingChanged();
    				OnPropertyChanged("UseMasterPricing");
    			}
    		}
    	}
    	private bool _useMasterPricing;
    	...
    	private void FixupProduct(Product previousValue)
    	{
    		...
    		if (previousValue != null && ReferenceEquals(previousValue.ProductVariantInfo, this))
    		{
    			previousValue.ProductVariantInfo = null;
    		}
    
    		if (Product != null)
    		{
    			Product.ProductVariantInfo = this;
