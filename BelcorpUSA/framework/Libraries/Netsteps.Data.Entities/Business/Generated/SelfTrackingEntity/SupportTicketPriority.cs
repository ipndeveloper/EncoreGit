...
namespace NetSteps.Data.Entities
{
    ...
    [Serializable]
    public partial class SupportTicketPriority: IObjectWithChangeTracker, INotifyPropertyChanged
    {
    	...
    	public short SupportTicketPriorityID
    	{
    		...
    		set
    		{
    			if (_supportTicketPriorityID != value)
    			{
    				...
    				{
    					throw new InvalidOperationException("The property 'SupportTicketPriorityID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
    				}
    	...
    	private void FixupSupportTickets(object sender, NotifyCollectionChangedEventArgs e)
    	{
    		...
    		if (e.NewItems != null)
    		{
    			...
    			{
    				item.SupportTicketPriority = this;
    				if (ChangeTracker.ChangeTrackingEnabled)
    				{
    		...
    		if (e.OldItems != null)
    		{
    			...
    			{
    				if (ReferenceEquals(item.SupportTicketPriority, this))
    				{
    					item.SupportTicketPriority = null;
    				}
    				if (ChangeTracker.ChangeTrackingEnabled)
    				{
