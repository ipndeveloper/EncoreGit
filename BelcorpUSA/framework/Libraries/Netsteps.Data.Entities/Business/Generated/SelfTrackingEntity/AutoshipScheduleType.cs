...
namespace NetSteps.Data.Entities
{
    ...
    [Serializable]
    public partial class AutoshipScheduleType: IObjectWithChangeTracker, INotifyPropertyChanged
    {
    	...
    	public int AutoshipScheduleTypeID
    	{
    		...
    		set
    		{
    			if (_autoshipScheduleTypeID != value)
    			{
    				...
    				{
    					throw new InvalidOperationException("The property 'AutoshipScheduleTypeID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
    				}
    	...
    	private void FixupAutoshipSchedules(object sender, NotifyCollectionChangedEventArgs e)
    	{
    		...
    		if (e.NewItems != null)
    		{
    			...
    			{
    				item.AutoshipScheduleType = this;
    				if (ChangeTracker.ChangeTrackingEnabled)
    				{
    		...
    		if (e.OldItems != null)
    		{
    			...
    			{
    				if (ReferenceEquals(item.AutoshipScheduleType, this))
    				{
    					item.AutoshipScheduleType = null;
    				}
    				if (ChangeTracker.ChangeTrackingEnabled)
    				{
