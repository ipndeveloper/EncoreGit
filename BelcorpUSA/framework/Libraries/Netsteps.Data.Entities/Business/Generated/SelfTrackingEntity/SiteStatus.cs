...
namespace NetSteps.Data.Entities
{
    ...
    [Serializable]
    public partial class SiteStatus: IObjectWithChangeTracker, INotifyPropertyChanged
    {
    	...
    	public short SiteStatusID
    	{
    		...
    		set
    		{
    			if (_siteStatusID != value)
    			{
    				...
    				{
    					throw new InvalidOperationException("The property 'SiteStatusID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
    				}
    				_siteStatusID = value;
    				SiteStatusIDChanged();
    	...
    	private void FixupSites(object sender, NotifyCollectionChangedEventArgs e)
    	{
    		...
    		if (e.OldItems != null)
    		{
    			...
    			{
    				if (ReferenceEquals(item.SiteStatus, this))
    				{
    					item.SiteStatus = null;
    				}
    				if (ChangeTracker.ChangeTrackingEnabled)
    				{
