...
namespace NetSteps.Data.Entities
{
    ...
    [Serializable]
    public partial class CreditCardType: IObjectWithChangeTracker, INotifyPropertyChanged
    {
    	...
    	public short CreditCardTypeID
    	{
    		...
    		set
    		{
    			if (_creditCardTypeID != value)
    			{
    				...
    				{
    					throw new InvalidOperationException("The property 'CreditCardTypeID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
    				}
    	...
    	private short _creditCardTypeID;
    	...
    	private void FixupCountries(object sender, NotifyCollectionChangedEventArgs e)
    	{
    		...
    		if (e.NewItems != null)
    		{
    			...
    			{
    				if (!item.CreditCardTypes.Contains(this))
    				{
    					item.CreditCardTypes.Add(this);
    				}
    				if (ChangeTracker.ChangeTrackingEnabled)
    				{
    		...
    		if (e.OldItems != null)
    		{
    			foreach (Country item in e.OldItems)
    			{
    				if (item.CreditCardTypes.Contains(this))
    				{
    					item.CreditCardTypes.Remove(this);
    				}
    				if (ChangeTracker.ChangeTrackingEnabled)
    				{
    	...
    	private void FixupOrderPayments(object sender, NotifyCollectionChangedEventArgs e)
    	{
    		...
    		if (e.OldItems != null)
    		{
    			...
    			{
    				if (ReferenceEquals(item.CreditCardType, this))
    				{
    					item.CreditCardType = null;
    				}
    				if (ChangeTracker.ChangeTrackingEnabled)
    				{
