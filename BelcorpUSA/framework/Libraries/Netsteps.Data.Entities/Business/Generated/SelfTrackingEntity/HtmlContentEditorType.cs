...
namespace NetSteps.Data.Entities
{
    ...
    [Serializable]
    public partial class HtmlContentEditorType: IObjectWithChangeTracker, INotifyPropertyChanged
    {
    	...
    	public short HtmlContentEditorTypeID
    	{
    		...
    		set
    		{
    			if (_htmlContentEditorTypeID != value)
    			{
    				...
    				{
    					throw new InvalidOperationException("The property 'HtmlContentEditorTypeID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
    				}
    	...
    	private void FixupHtmlSections(object sender, NotifyCollectionChangedEventArgs e)
    	{
    		...
    		if (e.NewItems != null)
    		{
    			...
    			{
    				item.HtmlContentEditorType = this;
    				if (ChangeTracker.ChangeTrackingEnabled)
    				{
    		...
    		if (e.OldItems != null)
    		{
    			...
    			{
    				if (ReferenceEquals(item.HtmlContentEditorType, this))
    				{
    					item.HtmlContentEditorType = null;
    				}
    				if (ChangeTracker.ChangeTrackingEnabled)
    				{
