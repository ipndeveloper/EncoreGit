...
namespace NetSteps.Data.Entities
{
    ...
    [Serializable]
    public partial class DomainEventTypeCategory: IObjectWithChangeTracker, INotifyPropertyChanged
    {
    	...
    	public int DomainEventTypeCategoryID
    	{
    		...
    		set
    		{
    			if (_domainEventTypeCategoryID != value)
    			{
    				...
    				{
    					throw new InvalidOperationException("The property 'DomainEventTypeCategoryID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
    				}
    	...
    	public TrackableCollection<DomainEventType> DomainEventTypes
    	{
    		get
    		{
    			if (_domainEventTypes == null)
    			{
    				...
    				_domainEventTypes.CollectionChanged += RaiseDomainEventTypesChanged;
    			}
    	...
    	partial void DomainEventTypesChanged();
    	private void RaiseDomainEventTypesChanged(object sender, NotifyCollectionChangedEventArgs e)
    	{
    		DomainEventTypesChanged();
    	}
    	...
    	private void FixupDomainEventTypes(object sender, NotifyCollectionChangedEventArgs e)
    	{
    		...
    		if (e.NewItems != null)
    		{
    			...
    			{
    				item.DomainEventTypeCategory = this;
    				if (ChangeTracker.ChangeTrackingEnabled)
    				{
    		...
    		if (e.OldItems != null)
    		{
    			...
    			{
    				if (ReferenceEquals(item.DomainEventTypeCategory, this))
    				{
    					item.DomainEventTypeCategory = null;
    				}
    				if (ChangeTracker.ChangeTrackingEnabled)
    				{
