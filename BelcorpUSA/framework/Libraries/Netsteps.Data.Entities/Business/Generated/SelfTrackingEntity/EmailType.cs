...
namespace NetSteps.Data.Entities
{
    ...
    [Serializable]
    public partial class EmailType: IObjectWithChangeTracker, INotifyPropertyChanged
    {
    	...
    	public short EmailTypeID
    	{
    		...
    		set
    		{
    			if (_emailTypeID != value)
    			{
    				...
    				{
    					throw new InvalidOperationException("The property 'EmailTypeID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
    				}
    				_emailTypeID = value;
    				EmailTypeIDChanged();
    	...
    	private void FixupAccountEmailLogs(object sender, NotifyCollectionChangedEventArgs e)
    	{
    		...
    		if (e.OldItems != null)
    		{
    			...
    			{
    				if (ReferenceEquals(item.EmailType, this))
    				{
    					item.EmailType = null;
    				}
    				if (ChangeTracker.ChangeTrackingEnabled)
