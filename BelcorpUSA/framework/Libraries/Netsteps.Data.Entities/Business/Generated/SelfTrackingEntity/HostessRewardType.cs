...
namespace NetSteps.Data.Entities
{
    ...
    [Serializable]
    public partial class HostessRewardType: IObjectWithChangeTracker, INotifyPropertyChanged
    {
    	...
    	public int HostessRewardTypeID
    	{
    		...
    		set
    		{
    			if (_hostessRewardTypeID != value)
    			{
    				...
    				{
    					throw new InvalidOperationException("The property 'HostessRewardTypeID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
    				}
    	...
    	private void FixupHostessRewardRules(object sender, NotifyCollectionChangedEventArgs e)
    	{
    		...
    		if (e.OldItems != null)
    		{
    			...
    			{
    				if (ReferenceEquals(item.HostessRewardType, this))
    				{
    					item.HostessRewardType = null;
    				}
    				if (ChangeTracker.ChangeTrackingEnabled)
    				{
    	...
    	private void FixupCatalogs(object sender, NotifyCollectionChangedEventArgs e)
    	{
    		...
    		if (e.NewItems != null)
    		{
    			...
    			{
    				if (!item.HostessRewardTypes.Contains(this))
    				{
    					item.HostessRewardTypes.Add(this);
    				}
    				if (ChangeTracker.ChangeTrackingEnabled)
    				{
    					if (!item.ChangeTracker.ChangeTrackingEnabled)
    		...
    		if (e.OldItems != null)
    		{
    			foreach (Catalog item in e.OldItems)
    			{
    				if (item.HostessRewardTypes.Contains(this))
    				{
    					item.HostessRewardTypes.Remove(this);
    				}
    				if (ChangeTracker.ChangeTrackingEnabled)
    				{
