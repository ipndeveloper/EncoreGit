...
namespace NetSteps.Data.Entities
{
    ...
    [Serializable]
    public partial class UserType: IObjectWithChangeTracker, INotifyPropertyChanged
    {
    	...
    	public short UserTypeID
    	{
    		...
    		set
    		{
    			if (_userTypeID != value)
    			{
    				...
    				{
    					throw new InvalidOperationException("The property 'UserTypeID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
    				}
    				_userTypeID = value;
    				UserTypeIDChanged();
