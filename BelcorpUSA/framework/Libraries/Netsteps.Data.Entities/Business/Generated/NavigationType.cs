...
{
    public partial class NavigationType : EntityBusinessBase<NavigationType, Int32, INavigationTypeRepository, INavigationTypeBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public NavigationType() : this(default(INavigationTypeRepository), default(INavigationTypeBusinessLogic))
    	{
    	}
    	public NavigationType(INavigationTypeRepository repo) : this(repo, default(INavigationTypeBusinessLogic))
    	{
    	}
    	public NavigationType(INavigationTypeRepository repo, INavigationTypeBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<NavigationType> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<NavigationType> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<NavigationType> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var navigationTypes = Repository.LoadAllFullWithSqlDependency();
    			foreach (var navigationType in navigationTypes)
    			{
    				navigationType.StartTracking();
    				navigationType.IsLazyLoadingEnabled = true;
    			}
