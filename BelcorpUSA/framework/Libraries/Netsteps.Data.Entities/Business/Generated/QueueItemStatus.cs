...
{
    public partial class QueueItemStatus : EntityBusinessBase<QueueItemStatus, Int16, IQueueItemStatusRepository, IQueueItemStatusBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public QueueItemStatus() : this(default(IQueueItemStatusRepository), default(IQueueItemStatusBusinessLogic))
    	{
    	}
    	public QueueItemStatus(IQueueItemStatusRepository repo) : this(repo, default(IQueueItemStatusBusinessLogic))
    	{
    	}
    	public QueueItemStatus(IQueueItemStatusRepository repo, IQueueItemStatusBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<QueueItemStatus> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<QueueItemStatus> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<QueueItemStatus> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var queueItemStatuses = Repository.LoadAllFullWithSqlDependency();
    			foreach (var queueItemStatus in queueItemStatuses)
    			{
    				queueItemStatus.StartTracking();
    				queueItemStatus.IsLazyLoadingEnabled = true;
    			}
    			return queueItemStatuses;
    		}
    		catch (Exception ex)
    		{
    			throw EntityExceptionHelper.GetAndLogNetStepsException(ex, Constants.NetStepsExceptionType.NetStepsBusinessException);
