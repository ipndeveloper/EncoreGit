...
{
    [Serializable]
    public partial class DomainEventCategoryType : EntityBusinessBase<DomainEventCategoryType, Int32, IDomainEventCategoryTypeRepository, IDomainEventCategoryTypeBusinessLogic>, IDatabaseValidationRules, ITermName  
    {
                                                                                                                                                                                                                                                                                                                                                                    #region Primitive Properties
    	
        protected TimeZoneInfo _currentTimeZoneInfo = TimeZoneInfo.Local;
        ...
        #region Constructors
        public DomainEventCategoryType()
        {
            InitializeEntity();
        }
        public DomainEventCategoryType(IDomainEventCategoryTypeRepository repo)
            : base(repo)
        {
            InitializeEntity();
        }
