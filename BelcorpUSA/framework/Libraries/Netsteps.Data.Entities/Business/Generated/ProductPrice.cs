...
{
    public partial class ProductPrice : EntityBusinessBase<ProductPrice, Int32, IProductPriceRepository, IProductPriceBusinessLogic>, IDatabaseValidationRules, IModifiedByUserID
    {
    	...
    	#region Constructors
    	public ProductPrice() : this(default(IProductPriceRepository), default(IProductPriceBusinessLogic))
    	{
    	}
    	public ProductPrice(IProductPriceRepository repo) : this(repo, default(IProductPriceBusinessLogic))
    	{
    	}
    	public ProductPrice(IProductPriceRepository repo, IProductPriceBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
