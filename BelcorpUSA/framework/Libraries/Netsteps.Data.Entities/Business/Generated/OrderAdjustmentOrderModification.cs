...
{
    public partial class OrderAdjustmentOrderModification : EntityBusinessBase<OrderAdjustmentOrderModification, Int32, IOrderAdjustmentOrderModificationRepository, IOrderAdjustmentOrderModificationBusinessLogic>, IDatabaseValidationRules, IDateCreated, IDateLastModified
    {
    	...
    	#region Constructors
    	public OrderAdjustmentOrderModification() : this(default(IOrderAdjustmentOrderModificationRepository), default(IOrderAdjustmentOrderModificationBusinessLogic))
    	{
    	}
    	public OrderAdjustmentOrderModification(IOrderAdjustmentOrderModificationRepository repo) : this(repo, default(IOrderAdjustmentOrderModificationBusinessLogic))
    	{
    	}
    	public OrderAdjustmentOrderModification(IOrderAdjustmentOrderModificationRepository repo, IOrderAdjustmentOrderModificationBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
