...
{
    public partial class ProductBase : EntityBusinessBase<ProductBase, Int32, IProductBaseRepository, IProductBaseBusinessLogic>, IDatabaseValidationRules, IModifiedByUserID, IEditable
    {
    	...
    	#region Constructors
    	public ProductBase() : this(default(IProductBaseRepository), default(IProductBaseBusinessLogic))
    	{
    	}
    	public ProductBase(IProductBaseRepository repo) : this(repo, default(IProductBaseBusinessLogic))
    	{
    	}
    	public ProductBase(IProductBaseRepository repo, IProductBaseBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	{ 
    		this.ValidationRules.AddRule(CommonRules.GreaterThanValue<int>, new CommonRules.CompareValueRuleArgs<int>("ProductTypeID", 0));
    		this.ValidationRules.AddRule(CommonRules.StringMaxLength, new CommonRules.MaxLengthRuleArgs("BaseSKU", 50));
