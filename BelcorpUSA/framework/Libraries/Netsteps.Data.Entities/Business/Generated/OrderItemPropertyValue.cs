...
{
    public partial class OrderItemPropertyValue : EntityBusinessBase<OrderItemPropertyValue, Int32, IOrderItemPropertyValueRepository, IOrderItemPropertyValueBusinessLogic>, IDatabaseValidationRules, IDateCreated, IDateLastModified
    {
    	...
    	#region Constructors
    	public OrderItemPropertyValue() : this(default(IOrderItemPropertyValueRepository), default(IOrderItemPropertyValueBusinessLogic))
    	{
    	}
    	public OrderItemPropertyValue(IOrderItemPropertyValueRepository repo) : this(repo, default(IOrderItemPropertyValueBusinessLogic))
    	{
    	}
    	public OrderItemPropertyValue(IOrderItemPropertyValueRepository repo, IOrderItemPropertyValueBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	{ 
    		this.ValidationRules.AddRule(CommonRules.GreaterThanValue<int>, new CommonRules.CompareValueRuleArgs<int>("OrderItemPropertyTypeID", 0));
