...
{
    public partial class Warehouse : EntityBusinessBase<Warehouse, Int32, IWarehouseRepository, IWarehouseBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public Warehouse() : this(default(IWarehouseRepository), default(IWarehouseBusinessLogic))
    	{
    	}
    	public Warehouse(IWarehouseRepository repo) : this(repo, default(IWarehouseBusinessLogic))
    	{
    	}
    	public Warehouse(IWarehouseRepository repo, IWarehouseBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<Warehouse> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<Warehouse> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var warehouses = Repository.LoadAllFullWithSqlDependency();
    			foreach (var warehouse in warehouses)
    			{
    				warehouse.StartTracking();
    				warehouse.IsLazyLoadingEnabled = true;
    			}
    			return warehouses;
    		}
    		catch (Exception ex)
