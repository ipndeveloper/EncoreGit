...
{
    public partial class CampaignType : EntityBusinessBase<CampaignType, Int16, ICampaignTypeRepository, ICampaignTypeBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public CampaignType() : this(default(ICampaignTypeRepository), default(ICampaignTypeBusinessLogic))
    	{
    	}
    	public CampaignType(ICampaignTypeRepository repo) : this(repo, default(ICampaignTypeBusinessLogic))
    	{
    	}
    	public CampaignType(ICampaignTypeRepository repo, ICampaignTypeBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<CampaignType> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<CampaignType> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<CampaignType> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var campaignTypes = Repository.LoadAllFullWithSqlDependency();
    			foreach (var campaignType in campaignTypes)
    			{
    				campaignType.StartTracking();
    				campaignType.IsLazyLoadingEnabled = true;
    			}
