...
{
    public partial class BankAccountType : EntityBusinessBase<BankAccountType, Int16, IBankAccountTypeRepository, IBankAccountTypeBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public BankAccountType() : this(default(IBankAccountTypeRepository), default(IBankAccountTypeBusinessLogic))
    	{
    	}
    	public BankAccountType(IBankAccountTypeRepository repo) : this(repo, default(IBankAccountTypeBusinessLogic))
    	{
    	}
    	public BankAccountType(IBankAccountTypeRepository repo, IBankAccountTypeBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
