...
{
    public partial class UserSiteWidget : EntityBusinessBase<UserSiteWidget, Int32, IUserSiteWidgetRepository, IUserSiteWidgetBusinessLogic>, IDatabaseValidationRules
    {
    	...
    	#region Constructors
    	public UserSiteWidget() : this(default(IUserSiteWidgetRepository), default(IUserSiteWidgetBusinessLogic))
    	{
    	}
    	public UserSiteWidget(IUserSiteWidgetRepository repo) : this(repo, default(IUserSiteWidgetBusinessLogic))
    	{
    	}
    	public UserSiteWidget(IUserSiteWidgetRepository repo, IUserSiteWidgetBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
