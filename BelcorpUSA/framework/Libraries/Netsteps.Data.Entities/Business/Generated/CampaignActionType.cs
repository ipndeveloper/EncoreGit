...
{
    public partial class CampaignActionType : EntityBusinessBase<CampaignActionType, Int16, ICampaignActionTypeRepository, ICampaignActionTypeBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public CampaignActionType() : this(default(ICampaignActionTypeRepository), default(ICampaignActionTypeBusinessLogic))
    	{
    	}
    	public CampaignActionType(ICampaignActionTypeRepository repo) : this(repo, default(ICampaignActionTypeBusinessLogic))
    	{
    	}
    	public CampaignActionType(ICampaignActionTypeRepository repo, ICampaignActionTypeBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<CampaignActionType> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<CampaignActionType> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<CampaignActionType> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var campaignActionTypes = Repository.LoadAllFullWithSqlDependency();
    			foreach (var campaignActionType in campaignActionTypes)
    			{
    				campaignActionType.StartTracking();
    				campaignActionType.IsLazyLoadingEnabled = true;
    			}
    			return campaignActionTypes;
    		}
    		catch (Exception ex)
    		{
    			throw EntityExceptionHelper.GetAndLogNetStepsException(ex, Constants.NetStepsExceptionType.NetStepsBusinessException);
