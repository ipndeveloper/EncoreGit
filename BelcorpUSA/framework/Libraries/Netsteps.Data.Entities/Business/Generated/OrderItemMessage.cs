...
{
    public partial class OrderItemMessage : EntityBusinessBase<OrderItemMessage, Int32, IOrderItemMessageRepository, IOrderItemMessageBusinessLogic>, IDatabaseValidationRules, IDateCreated, IDateLastModified
    {
    	...
    	#region Constructors
    	public OrderItemMessage() : this(default(IOrderItemMessageRepository), default(IOrderItemMessageBusinessLogic))
    	{
    	}
    	public OrderItemMessage(IOrderItemMessageRepository repo) : this(repo, default(IOrderItemMessageBusinessLogic))
    	{
    	}
    	public OrderItemMessage(IOrderItemMessageRepository repo, IOrderItemMessageBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	{ 
    		...
    		this.ValidationRules.AddRule(CommonRules.StringMaxLength, new CommonRules.MaxLengthRuleArgs("MessageSourceKey", 50));
    		this.ValidationRules.AddRule(CommonRules.NotNull, new ValidationRuleArgs("MessageSourceKey"));
    		this.ValidationRules.AddRule(CommonRules.StringMaxLength, new CommonRules.MaxLengthRuleArgs("Message", 400));
    		this.ValidationRules.AddRule(CommonRules.NotNull, new ValidationRuleArgs("Message"));
