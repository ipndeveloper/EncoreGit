...
{
    public partial class Function : EntityBusinessBase<Function, Int32, IFunctionRepository, IFunctionBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public Function() : this(default(IFunctionRepository), default(IFunctionBusinessLogic))
    	{
    	}
    	public Function(IFunctionRepository repo) : this(repo, default(IFunctionBusinessLogic))
    	{
    	}
    	public Function(IFunctionRepository repo, IFunctionBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<Function> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<Function> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<Function> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var functions = Repository.LoadAllFullWithSqlDependency();
    			foreach (var function in functions)
    			{
    				function.StartTracking();
    				function.IsLazyLoadingEnabled = true;
    			}
    			return functions;
    		}
    		catch (Exception ex)
