...
{
    public partial class OrderItemType : EntityBusinessBase<OrderItemType, Int16, IOrderItemTypeRepository, IOrderItemTypeBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public OrderItemType() : this(default(IOrderItemTypeRepository), default(IOrderItemTypeBusinessLogic))
    	{
    	}
    	public OrderItemType(IOrderItemTypeRepository repo) : this(repo, default(IOrderItemTypeBusinessLogic))
    	{
    	}
    	public OrderItemType(IOrderItemTypeRepository repo, IOrderItemTypeBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<OrderItemType> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<OrderItemType> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<OrderItemType> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var orderItemTypes = Repository.LoadAllFullWithSqlDependency();
    			foreach (var orderItemType in orderItemTypes)
    			{
    				orderItemType.StartTracking();
    				orderItemType.IsLazyLoadingEnabled = true;
    			}
