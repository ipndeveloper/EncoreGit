...
{
    public partial class PhoneType : EntityBusinessBase<PhoneType, Int32, IPhoneTypeRepository, IPhoneTypeBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public PhoneType() : this(default(IPhoneTypeRepository), default(IPhoneTypeBusinessLogic))
    	{
    	}
    	public PhoneType(IPhoneTypeRepository repo) : this(repo, default(IPhoneTypeBusinessLogic))
    	{
    	}
    	public PhoneType(IPhoneTypeRepository repo, IPhoneTypeBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<PhoneType> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<PhoneType> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<PhoneType> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var phoneTypes = Repository.LoadAllFullWithSqlDependency();
    			foreach (var phoneType in phoneTypes)
    			{
    				phoneType.StartTracking();
    				phoneType.IsLazyLoadingEnabled = true;
    			}
    			return phoneTypes;
    		}
    		catch (Exception ex)
