...
{
    public partial class UserType : EntityBusinessBase<UserType, Int16, IUserTypeRepository, IUserTypeBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public UserType() : this(default(IUserTypeRepository), default(IUserTypeBusinessLogic))
    	{
    	}
    	public UserType(IUserTypeRepository repo) : this(repo, default(IUserTypeBusinessLogic))
    	{
    	}
    	public UserType(IUserTypeRepository repo, IUserTypeBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<UserType> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<UserType> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<UserType> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var userTypes = Repository.LoadAllFullWithSqlDependency();
    			foreach (var userType in userTypes)
    			{
    				userType.StartTracking();
    				userType.IsLazyLoadingEnabled = true;
    			}
    			return userTypes;
    		}
    		catch (Exception ex)
