...
{
    public partial class EmailType : EntityBusinessBase<EmailType, Int16, IEmailTypeRepository, IEmailTypeBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public EmailType() : this(default(IEmailTypeRepository), default(IEmailTypeBusinessLogic))
    	{
    	}
    	public EmailType(IEmailTypeRepository repo) : this(repo, default(IEmailTypeBusinessLogic))
    	{
    	}
    	public EmailType(IEmailTypeRepository repo, IEmailTypeBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
