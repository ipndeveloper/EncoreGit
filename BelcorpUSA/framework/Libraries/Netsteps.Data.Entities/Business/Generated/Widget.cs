...
{
    public partial class Widget : EntityBusinessBase<Widget, Int32, IWidgetRepository, IWidgetBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public Widget() : this(default(IWidgetRepository), default(IWidgetBusinessLogic))
    	{
    	}
    	public Widget(IWidgetRepository repo) : this(repo, default(IWidgetBusinessLogic))
    	{
    	}
    	public Widget(IWidgetRepository repo, IWidgetBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	{ 
    		...
    		this.ValidationRules.AddRule(CommonRules.StringMaxLength, new CommonRules.MaxLengthRuleArgs("ViewName", 255));
    		this.ValidationRules.AddRule(CommonRules.StringMaxLength, new CommonRules.MaxLengthRuleArgs("Path", 255));
    	}
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<Widget> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<Widget> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var widgets = Repository.LoadAllFullWithSqlDependency();
    			foreach (var widget in widgets)
    			{
    				widget.StartTracking();
    				widget.IsLazyLoadingEnabled = true;
    			}
    			return widgets;
    		}
    		catch (Exception ex)
