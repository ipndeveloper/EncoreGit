...
{
    public partial class DeviceType : EntityBusinessBase<DeviceType, Int16, IDeviceTypeRepository, IDeviceTypeBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public DeviceType() : this(default(IDeviceTypeRepository), default(IDeviceTypeBusinessLogic))
    	{
    	}
    	public DeviceType(IDeviceTypeRepository repo) : this(repo, default(IDeviceTypeBusinessLogic))
    	{
    	}
    	public DeviceType(IDeviceTypeRepository repo, IDeviceTypeBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
