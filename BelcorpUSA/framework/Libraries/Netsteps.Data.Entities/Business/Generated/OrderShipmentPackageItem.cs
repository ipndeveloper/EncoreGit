...
{
    public partial class OrderShipmentPackageItem : EntityBusinessBase<OrderShipmentPackageItem, Int32, IOrderShipmentPackageItemRepository, IOrderShipmentPackageItemBusinessLogic>, IDatabaseValidationRules, IDateCreated, IDateLastModified
    {
    	...
    	#region Constructors
    	public OrderShipmentPackageItem() : this(default(IOrderShipmentPackageItemRepository), default(IOrderShipmentPackageItemBusinessLogic))
    	{
    	}
    	public OrderShipmentPackageItem(IOrderShipmentPackageItemRepository repo) : this(repo, default(IOrderShipmentPackageItemBusinessLogic))
    	{
    	}
    	public OrderShipmentPackageItem(IOrderShipmentPackageItemRepository repo, IOrderShipmentPackageItemBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	{ 
    		this.ValidationRules.AddRule(CommonRules.GreaterThanValue<int>, new CommonRules.CompareValueRuleArgs<int>("OrderShipmentPackageID", 0));
