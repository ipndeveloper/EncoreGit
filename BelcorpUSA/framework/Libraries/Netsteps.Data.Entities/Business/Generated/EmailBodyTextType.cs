...
{
    public partial class EmailBodyTextType : EntityBusinessBase<EmailBodyTextType, Int16, IEmailBodyTextTypeRepository, IEmailBodyTextTypeBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public EmailBodyTextType() : this(default(IEmailBodyTextTypeRepository), default(IEmailBodyTextTypeBusinessLogic))
    	{
    	}
    	public EmailBodyTextType(IEmailBodyTextTypeRepository repo) : this(repo, default(IEmailBodyTextTypeBusinessLogic))
    	{
    	}
    	public EmailBodyTextType(IEmailBodyTextTypeRepository repo, IEmailBodyTextTypeBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<EmailBodyTextType> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<EmailBodyTextType> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<EmailBodyTextType> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var emailBodyTextTypes = Repository.LoadAllFullWithSqlDependency();
    			foreach (var emailBodyTextType in emailBodyTextTypes)
    			{
    				emailBodyTextType.StartTracking();
    				emailBodyTextType.IsLazyLoadingEnabled = true;
    			}
    			return emailBodyTextTypes;
    		}
    		catch (Exception ex)
    		{
    			throw EntityExceptionHelper.GetAndLogNetStepsException(ex, Constants.NetStepsExceptionType.NetStepsBusinessException);
