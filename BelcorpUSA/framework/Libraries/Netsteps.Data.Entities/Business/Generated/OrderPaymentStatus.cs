...
{
    public partial class OrderPaymentStatus : EntityBusinessBase<OrderPaymentStatus, Int16, IOrderPaymentStatusRepository, IOrderPaymentStatusBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public OrderPaymentStatus() : this(default(IOrderPaymentStatusRepository), default(IOrderPaymentStatusBusinessLogic))
    	{
    	}
    	public OrderPaymentStatus(IOrderPaymentStatusRepository repo) : this(repo, default(IOrderPaymentStatusBusinessLogic))
    	{
    	}
    	public OrderPaymentStatus(IOrderPaymentStatusRepository repo, IOrderPaymentStatusBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<OrderPaymentStatus> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<OrderPaymentStatus> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<OrderPaymentStatus> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var orderPaymentStatuses = Repository.LoadAllFullWithSqlDependency();
    			foreach (var orderPaymentStatus in orderPaymentStatuses)
    			{
    				orderPaymentStatus.StartTracking();
    				orderPaymentStatus.IsLazyLoadingEnabled = true;
    			}
