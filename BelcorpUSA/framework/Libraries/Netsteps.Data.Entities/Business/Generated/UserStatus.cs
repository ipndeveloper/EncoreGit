...
{
    public partial class UserStatus : EntityBusinessBase<UserStatus, Int16, IUserStatusRepository, IUserStatusBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public UserStatus() : this(default(IUserStatusRepository), default(IUserStatusBusinessLogic))
    	{
    	}
    	public UserStatus(IUserStatusRepository repo) : this(repo, default(IUserStatusBusinessLogic))
    	{
    	}
    	public UserStatus(IUserStatusRepository repo, IUserStatusBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<UserStatus> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<UserStatus> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<UserStatus> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var userStatuses = Repository.LoadAllFullWithSqlDependency();
    			foreach (var userStatus in userStatuses)
    			{
    				userStatus.StartTracking();
    				userStatus.IsLazyLoadingEnabled = true;
    			}
    			return userStatuses;
    		}
    		catch (Exception ex)
