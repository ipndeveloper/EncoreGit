...
{
    public partial class ShippingRateType : EntityBusinessBase<ShippingRateType, Int16, IShippingRateTypeRepository, IShippingRateTypeBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public ShippingRateType() : this(default(IShippingRateTypeRepository), default(IShippingRateTypeBusinessLogic))
    	{
    	}
    	public ShippingRateType(IShippingRateTypeRepository repo) : this(repo, default(IShippingRateTypeBusinessLogic))
    	{
    	}
    	public ShippingRateType(IShippingRateTypeRepository repo, IShippingRateTypeBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<ShippingRateType> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<ShippingRateType> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<ShippingRateType> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var shippingRateTypes = Repository.LoadAllFullWithSqlDependency();
    			foreach (var shippingRateType in shippingRateTypes)
    			{
    				shippingRateType.StartTracking();
    				shippingRateType.IsLazyLoadingEnabled = true;
    			}
    			return shippingRateTypes;
    		}
    		catch (Exception ex)
    		{
    			throw EntityExceptionHelper.GetAndLogNetStepsException(ex, Constants.NetStepsExceptionType.NetStepsBusinessException);
