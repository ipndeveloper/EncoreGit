...
{
    public partial class ProductRelation : EntityBusinessBase<ProductRelation, Int32, IProductRelationRepository, IProductRelationBusinessLogic>, IDatabaseValidationRules
    {
    	...
    	#region Constructors
    	public ProductRelation() : this(default(IProductRelationRepository), default(IProductRelationBusinessLogic))
    	{
    	}
    	public ProductRelation(IProductRelationRepository repo) : this(repo, default(IProductRelationBusinessLogic))
    	{
    	}
    	public ProductRelation(IProductRelationRepository repo, IProductRelationBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	{ 
    		this.ValidationRules.AddRule(CommonRules.GreaterThanValue<int>, new CommonRules.CompareValueRuleArgs<int>("ProductRelationsTypeID", 0));
    		this.ValidationRules.AddRule(CommonRules.GreaterThanValue<int>, new CommonRules.CompareValueRuleArgs<int>("ParentProductID", 0));
