...
{
    public partial class CategoryTranslation : EntityBusinessBase<CategoryTranslation, Int32, ICategoryTranslationRepository, ICategoryTranslationBusinessLogic>, IDatabaseValidationRules, ILanguageID
    {
    	...
    	#region Constructors
    	public CategoryTranslation() : this(default(ICategoryTranslationRepository), default(ICategoryTranslationBusinessLogic))
    	{
    	}
    	public CategoryTranslation(ICategoryTranslationRepository repo) : this(repo, default(ICategoryTranslationBusinessLogic))
    	{
    	}
    	public CategoryTranslation(ICategoryTranslationRepository repo, ICategoryTranslationBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
