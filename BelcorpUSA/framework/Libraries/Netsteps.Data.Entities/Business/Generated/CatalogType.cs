...
{
    public partial class CatalogType : EntityBusinessBase<CatalogType, Int16, ICatalogTypeRepository, ICatalogTypeBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public CatalogType() : this(default(ICatalogTypeRepository), default(ICatalogTypeBusinessLogic))
    	{
    	}
    	public CatalogType(ICatalogTypeRepository repo) : this(repo, default(ICatalogTypeBusinessLogic))
    	{
    	}
    	public CatalogType(ICatalogTypeRepository repo, ICatalogTypeBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<CatalogType> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<CatalogType> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<CatalogType> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var catalogTypes = Repository.LoadAllFullWithSqlDependency();
    			foreach (var catalogType in catalogTypes)
    			{
    				catalogType.StartTracking();
    				catalogType.IsLazyLoadingEnabled = true;
    			}
    			return catalogTypes;
    		}
    		catch (Exception ex)
