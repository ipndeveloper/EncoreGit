...
{
    public partial class Party : EntityBusinessBase<Party, Int32, IPartyRepository, IPartyBusinessLogic>, IDatabaseValidationRules, IModifiedByUserID, IDataVersion
    {
    	...
    	#region Constructors
    	public Party() : this(default(IPartyRepository), default(IPartyBusinessLogic))
    	{
    	}
    	public Party(IPartyRepository repo) : this(repo, default(IPartyBusinessLogic))
    	{
    	}
    	public Party(IPartyRepository repo, IPartyBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	{ 
    		...
    		this.ValidationRules.AddRule(CommonRules.StringMaxLength, new CommonRules.MaxLengthRuleArgs("EviteOrganizerEmail", 255));
