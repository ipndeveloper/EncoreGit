...
{
    public partial class OrderStatus : EntityBusinessBase<OrderStatus, Int16, IOrderStatusRepository, IOrderStatusBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public OrderStatus() : this(default(IOrderStatusRepository), default(IOrderStatusBusinessLogic))
    	{
    	}
    	public OrderStatus(IOrderStatusRepository repo) : this(repo, default(IOrderStatusBusinessLogic))
    	{
    	}
    	public OrderStatus(IOrderStatusRepository repo, IOrderStatusBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<OrderStatus> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<OrderStatus> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<OrderStatus> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var orderStatuses = Repository.LoadAllFullWithSqlDependency();
    			foreach (var orderStatus in orderStatuses)
    			{
    				orderStatus.StartTracking();
    				orderStatus.IsLazyLoadingEnabled = true;
    			}
