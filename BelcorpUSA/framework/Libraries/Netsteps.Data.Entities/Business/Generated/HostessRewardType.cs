...
{
    public partial class HostessRewardType : EntityBusinessBase<HostessRewardType, Int32, IHostessRewardTypeRepository, IHostessRewardTypeBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public HostessRewardType() : this(default(IHostessRewardTypeRepository), default(IHostessRewardTypeBusinessLogic))
    	{
    	}
    	public HostessRewardType(IHostessRewardTypeRepository repo) : this(repo, default(IHostessRewardTypeBusinessLogic))
    	{
    	}
    	public HostessRewardType(IHostessRewardTypeRepository repo, IHostessRewardTypeBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<HostessRewardType> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<HostessRewardType> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<HostessRewardType> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var hostessRewardTypes = Repository.LoadAllFullWithSqlDependency();
    			foreach (var hostessRewardType in hostessRewardTypes)
    			{
    				hostessRewardType.StartTracking();
    				hostessRewardType.IsLazyLoadingEnabled = true;
    			}
    			return hostessRewardTypes;
    		}
    		catch (Exception ex)
    		{
    			throw EntityExceptionHelper.GetAndLogNetStepsException(ex, Constants.NetStepsExceptionType.NetStepsBusinessException);
