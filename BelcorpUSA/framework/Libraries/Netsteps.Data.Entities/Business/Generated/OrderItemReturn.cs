...
{
    public partial class OrderItemReturn : EntityBusinessBase<OrderItemReturn, Int32, IOrderItemReturnRepository, IOrderItemReturnBusinessLogic>, IDatabaseValidationRules, IDateCreated, IDateLastModified
    {
    	...
    	#region Constructors
    	public OrderItemReturn() : this(default(IOrderItemReturnRepository), default(IOrderItemReturnBusinessLogic))
    	{
    	}
    	public OrderItemReturn(IOrderItemReturnRepository repo) : this(repo, default(IOrderItemReturnBusinessLogic))
    	{
    	}
    	public OrderItemReturn(IOrderItemReturnRepository repo, IOrderItemReturnBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	{ 
    		...
    		this.ValidationRules.AddRule(CommonRules.GreaterThanValue<int>, new CommonRules.CompareValueRuleArgs<int>("ReturnReasonID", 0));
