...
{
    public partial class OrderItem : EntityBusinessBase<OrderItem, Int32, IOrderItemRepository, IOrderItemBusinessLogic>, IDatabaseValidationRules, IModifiedByUserID, IDateCreated, IDateLastModified
    {
    	...
    	#region Constructors
    	public OrderItem() : this(default(IOrderItemRepository), default(IOrderItemBusinessLogic))
    	{
    	}
    	public OrderItem(IOrderItemRepository repo) : this(repo, default(IOrderItemBusinessLogic))
    	{
    	}
    	public OrderItem(IOrderItemRepository repo, IOrderItemBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	{ 
    		...
    		this.ValidationRules.AddRule(CommonRules.GreaterThanValue<short>, new CommonRules.CompareValueRuleArgs<short>("OrderItemTypeID", 0));
    		this.ValidationRules.AddRule(CommonRules.StringMaxLength, new CommonRules.MaxLengthRuleArgs("ProductName", 250));
    		this.ValidationRules.AddRule(CommonRules.StringMaxLength, new CommonRules.MaxLengthRuleArgs("SKU", 50));
    		this.ValidationRules.AddRule(CommonRules.StringMaxLength, new CommonRules.MaxLengthRuleArgs("TaxNumber", 40));
