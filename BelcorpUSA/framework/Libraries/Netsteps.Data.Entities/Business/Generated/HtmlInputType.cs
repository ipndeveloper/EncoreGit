...
{
    public partial class HtmlInputType : EntityBusinessBase<HtmlInputType, Int16, IHtmlInputTypeRepository, IHtmlInputTypeBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public HtmlInputType() : this(default(IHtmlInputTypeRepository), default(IHtmlInputTypeBusinessLogic))
    	{
    	}
    	public HtmlInputType(IHtmlInputTypeRepository repo) : this(repo, default(IHtmlInputTypeBusinessLogic))
    	{
    	}
    	public HtmlInputType(IHtmlInputTypeRepository repo, IHtmlInputTypeBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<HtmlInputType> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<HtmlInputType> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<HtmlInputType> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var htmlInputTypes = Repository.LoadAllFullWithSqlDependency();
    			foreach (var htmlInputType in htmlInputTypes)
    			{
    				htmlInputType.StartTracking();
    				htmlInputType.IsLazyLoadingEnabled = true;
    			}
