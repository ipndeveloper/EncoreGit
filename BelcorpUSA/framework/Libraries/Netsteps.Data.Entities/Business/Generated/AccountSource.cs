...
{
    public partial class AccountSource : EntityBusinessBase<AccountSource, Int16, IAccountSourceRepository, IAccountSourceBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public AccountSource() : this(default(IAccountSourceRepository), default(IAccountSourceBusinessLogic))
    	{
    	}
    	public AccountSource(IAccountSourceRepository repo) : this(repo, default(IAccountSourceBusinessLogic))
    	{
    	}
    	public AccountSource(IAccountSourceRepository repo, IAccountSourceBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<AccountSource> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<AccountSource> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<AccountSource> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var accountSources = Repository.LoadAllFullWithSqlDependency();
    			foreach (var accountSource in accountSources)
    			{
    				accountSource.StartTracking();
    				accountSource.IsLazyLoadingEnabled = true;
    			}
