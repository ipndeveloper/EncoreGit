...
{
    public partial class TimeUnitType : EntityBusinessBase<TimeUnitType, Int16, ITimeUnitTypeRepository, ITimeUnitTypeBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public TimeUnitType() : this(default(ITimeUnitTypeRepository), default(ITimeUnitTypeBusinessLogic))
    	{
    	}
    	public TimeUnitType(ITimeUnitTypeRepository repo) : this(repo, default(ITimeUnitTypeBusinessLogic))
    	{
    	}
    	public TimeUnitType(ITimeUnitTypeRepository repo, ITimeUnitTypeBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<TimeUnitType> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<TimeUnitType> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<TimeUnitType> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var timeUnitTypes = Repository.LoadAllFullWithSqlDependency();
    			foreach (var timeUnitType in timeUnitTypes)
    			{
    				timeUnitType.StartTracking();
    				timeUnitType.IsLazyLoadingEnabled = true;
    			}
