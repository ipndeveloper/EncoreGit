...
{
    public partial class AlertPriority : EntityBusinessBase<AlertPriority, Int16, IAlertPriorityRepository, IAlertPriorityBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public AlertPriority() : this(default(IAlertPriorityRepository), default(IAlertPriorityBusinessLogic))
    	{
    	}
    	public AlertPriority(IAlertPriorityRepository repo) : this(repo, default(IAlertPriorityBusinessLogic))
    	{
    	}
    	public AlertPriority(IAlertPriorityRepository repo, IAlertPriorityBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<AlertPriority> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<AlertPriority> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<AlertPriority> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var alertPriorities = Repository.LoadAllFullWithSqlDependency();
    			foreach (var alertPriority in alertPriorities)
    			{
    				alertPriority.StartTracking();
    				alertPriority.IsLazyLoadingEnabled = true;
    			}
    			return alertPriorities;
    		}
    		catch (Exception ex)
    		{
    			throw EntityExceptionHelper.GetAndLogNetStepsException(ex, Constants.NetStepsExceptionType.NetStepsBusinessException);
