...
{
    public partial class Navigation : EntityBusinessBase<Navigation, Int32, INavigationRepository, INavigationBusinessLogic>, IDatabaseValidationRules, IModifiedByUserID, ISortIndex, IActive, IDateRange
    {
    	...
    	#region Constructors
    	public Navigation() : this(default(INavigationRepository), default(INavigationBusinessLogic))
    	{
    	}
    	public Navigation(INavigationRepository repo) : this(repo, default(INavigationBusinessLogic))
    	{
    	}
    	public Navigation(INavigationRepository repo, INavigationBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
