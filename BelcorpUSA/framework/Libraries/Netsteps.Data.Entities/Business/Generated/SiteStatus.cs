...
{
    public partial class SiteStatus : EntityBusinessBase<SiteStatus, Int16, ISiteStatusRepository, ISiteStatusBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public SiteStatus() : this(default(ISiteStatusRepository), default(ISiteStatusBusinessLogic))
    	{
    	}
    	public SiteStatus(ISiteStatusRepository repo) : this(repo, default(ISiteStatusBusinessLogic))
    	{
    	}
    	public SiteStatus(ISiteStatusRepository repo, ISiteStatusBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<SiteStatus> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<SiteStatus> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<SiteStatus> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var siteStatuses = Repository.LoadAllFullWithSqlDependency();
    			foreach (var siteStatus in siteStatuses)
    			{
    				siteStatus.StartTracking();
    				siteStatus.IsLazyLoadingEnabled = true;
    			}
    			return siteStatuses;
    		}
    		catch (Exception ex)
