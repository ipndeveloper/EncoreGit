...
{
    public partial class Catalog : EntityBusinessBase<Catalog, Int32, ICatalogRepository, ICatalogBusinessLogic>, IDatabaseValidationRules, ISortIndex, IEditable, IActive, IDateRange
    {
    	...
    	#region Constructors
    	public Catalog() : this(default(ICatalogRepository), default(ICatalogBusinessLogic))
    	{
    	}
    	public Catalog(ICatalogRepository repo) : this(repo, default(ICatalogBusinessLogic))
    	{
    	}
    	public Catalog(ICatalogRepository repo, ICatalogBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	{ 
    		this.ValidationRules.AddRule(CommonRules.GreaterThanValue<int>, new CommonRules.CompareValueRuleArgs<int>("CategoryID", 0));
    		this.ValidationRules.AddRule(CommonRules.StringMaxLength, new CommonRules.MaxLengthRuleArgs("DisplayImage", 255));
    		...
    		this.ValidationRules.AddRule(CommonRules.GreaterThanValue<short>, new CommonRules.CompareValueRuleArgs<short>("CatalogTypeID", 0));
