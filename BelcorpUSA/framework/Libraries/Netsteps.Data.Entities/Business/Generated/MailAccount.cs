...
{
    public partial class MailAccount : EntityBusinessBase<MailAccount, Int32, IMailAccountRepository, IMailAccountBusinessLogic>, IDatabaseValidationRules, IModifiedByUserID, IActive, IDataVersion
    {
    	...
    	#region Constructors
    	public MailAccount() : this(default(IMailAccountRepository), default(IMailAccountBusinessLogic))
    	{
    	}
    	public MailAccount(IMailAccountRepository repo) : this(repo, default(IMailAccountBusinessLogic))
    	{
    	}
    	public MailAccount(IMailAccountRepository repo, IMailAccountBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	{ 
    		...
    		this.ValidationRules.AddRule(CommonRules.StringMaxLength, new CommonRules.MaxLengthRuleArgs("PasswordOLD", 255));
