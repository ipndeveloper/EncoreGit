...
{
    public partial class OrderType : EntityBusinessBase<OrderType, Int16, IOrderTypeRepository, IOrderTypeBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public OrderType() : this(default(IOrderTypeRepository), default(IOrderTypeBusinessLogic))
    	{
    	}
    	public OrderType(IOrderTypeRepository repo) : this(repo, default(IOrderTypeBusinessLogic))
    	{
    	}
    	public OrderType(IOrderTypeRepository repo, IOrderTypeBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<OrderType> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<OrderType> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<OrderType> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var orderTypes = Repository.LoadAllFullWithSqlDependency();
    			foreach (var orderType in orderTypes)
    			{
    				orderType.StartTracking();
    				orderType.IsLazyLoadingEnabled = true;
    			}
    			return orderTypes;
    		}
    		catch (Exception ex)
