...
{
    public partial class LogisticsProvider : EntityBusinessBase<LogisticsProvider, Int16, ILogisticsProviderRepository, ILogisticsProviderBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public LogisticsProvider() : this(default(ILogisticsProviderRepository), default(ILogisticsProviderBusinessLogic))
    	{
    	}
    	public LogisticsProvider(ILogisticsProviderRepository repo) : this(repo, default(ILogisticsProviderBusinessLogic))
    	{
    	}
    	public LogisticsProvider(ILogisticsProviderRepository repo, ILogisticsProviderBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	{ 
    		...
    		this.ValidationRules.AddRule(CommonRules.StringMaxLength, new CommonRules.MaxLengthRuleArgs("FaxNumber", 50));
    		...
    		this.ValidationRules.AddRule(CommonRules.StringMaxLength, new CommonRules.MaxLengthRuleArgs("ExternalCode", 50));
    		this.ValidationRules.AddRule(CommonRules.StringMaxLength, new CommonRules.MaxLengthRuleArgs("ExternalTrakingURL", 500));
    		this.ValidationRules.AddRule(CommonRules.StringMaxLength, new CommonRules.MaxLengthRuleArgs("PhoneNumber", 50));
    		this.ValidationRules.AddRule(CommonRules.NotNull, new ValidationRuleArgs("PhoneNumber"));
    	}
    	#endregion
    }
}
