...
{
    public partial class OrderAdjustment : EntityBusinessBase<OrderAdjustment, Int32, IOrderAdjustmentRepository, IOrderAdjustmentBusinessLogic>, IDatabaseValidationRules, IDateCreated, IDateLastModified
    {
    	...
    	#region Constructors
    	public OrderAdjustment() : this(default(IOrderAdjustmentRepository), default(IOrderAdjustmentBusinessLogic))
    	{
    	}
    	public OrderAdjustment(IOrderAdjustmentRepository repo) : this(repo, default(IOrderAdjustmentBusinessLogic))
    	{
    	}
    	public OrderAdjustment(IOrderAdjustmentRepository repo, IOrderAdjustmentBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	{ 
    		...
    		this.ValidationRules.AddRule(CommonRules.NotNull, new ValidationRuleArgs("Description"));
    		this.ValidationRules.AddRule(CommonRules.StringMaxLength, new CommonRules.MaxLengthRuleArgs("ExtensionProviderKey", 250));
    		this.ValidationRules.AddRule(CommonRules.NotNull, new ValidationRuleArgs("ExtensionProviderKey"));
