...
{
    public partial class AutoresponderType : EntityBusinessBase<AutoresponderType, Int16, IAutoresponderTypeRepository, IAutoresponderTypeBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public AutoresponderType() : this(default(IAutoresponderTypeRepository), default(IAutoresponderTypeBusinessLogic))
    	{
    	}
    	public AutoresponderType(IAutoresponderTypeRepository repo) : this(repo, default(IAutoresponderTypeBusinessLogic))
    	{
    	}
    	public AutoresponderType(IAutoresponderTypeRepository repo, IAutoresponderTypeBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<AutoresponderType> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<AutoresponderType> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<AutoresponderType> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var autoresponderTypes = Repository.LoadAllFullWithSqlDependency();
    			foreach (var autoresponderType in autoresponderTypes)
    			{
    				autoresponderType.StartTracking();
    				autoresponderType.IsLazyLoadingEnabled = true;
    			}
    			return autoresponderTypes;
    		}
    		catch (Exception ex)
    		{
    			throw EntityExceptionHelper.GetAndLogNetStepsException(ex, Constants.NetStepsExceptionType.NetStepsBusinessException);
