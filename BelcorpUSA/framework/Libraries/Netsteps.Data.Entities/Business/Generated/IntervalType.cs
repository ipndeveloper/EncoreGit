...
{
    public partial class IntervalType : EntityBusinessBase<IntervalType, Int32, IIntervalTypeRepository, IIntervalTypeBusinessLogic>, IDatabaseValidationRules, ITermName
    {
    	...
    	#region Constructors
    	public IntervalType() : this(default(IIntervalTypeRepository), default(IIntervalTypeBusinessLogic))
    	{
    	}
    	public IntervalType(IIntervalTypeRepository repo) : this(repo, default(IIntervalTypeBusinessLogic))
    	{
    	}
    	public IntervalType(IIntervalTypeRepository repo, IIntervalTypeBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<IntervalType> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<IntervalType> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<IntervalType> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var intervalTypes = Repository.LoadAllFullWithSqlDependency();
    			foreach (var intervalType in intervalTypes)
    			{
    				intervalType.StartTracking();
    				intervalType.IsLazyLoadingEnabled = true;
    			}
