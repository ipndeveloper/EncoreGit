...
{
    public partial class Gender : EntityBusinessBase<Gender, Int16, IGenderRepository, IGenderBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public Gender() : this(default(IGenderRepository), default(IGenderBusinessLogic))
    	{
    	}
    	public Gender(IGenderRepository repo) : this(repo, default(IGenderBusinessLogic))
    	{
    	}
    	public Gender(IGenderRepository repo, IGenderBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<Gender> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<Gender> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<Gender> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var genders = Repository.LoadAllFullWithSqlDependency();
    			foreach (var gender in genders)
    			{
    				gender.StartTracking();
    				gender.IsLazyLoadingEnabled = true;
    			}
    			return genders;
    		}
    		catch (Exception ex)
