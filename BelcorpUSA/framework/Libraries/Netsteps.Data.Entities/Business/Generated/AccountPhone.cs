...
{
    public partial class AccountPhone : EntityBusinessBase<AccountPhone, Int32, IAccountPhoneRepository, IAccountPhoneBusinessLogic>, IDatabaseValidationRules, IModifiedByUserID, IDataVersion
    {
    	...
    	#region Constructors
    	public AccountPhone() : this(default(IAccountPhoneRepository), default(IAccountPhoneBusinessLogic))
    	{
    	}
    	public AccountPhone(IAccountPhoneRepository repo) : this(repo, default(IAccountPhoneBusinessLogic))
    	{
    	}
    	public AccountPhone(IAccountPhoneRepository repo, IAccountPhoneBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	{ 
    		...
    		this.ValidationRules.AddRule(CommonRules.GreaterThanValue<int>, new CommonRules.CompareValueRuleArgs<int>("PhoneTypeID", 0));
