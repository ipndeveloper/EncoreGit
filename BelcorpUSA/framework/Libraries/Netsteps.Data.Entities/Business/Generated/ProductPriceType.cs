...
{
    public partial class ProductPriceType : EntityBusinessBase<ProductPriceType, Int32, IProductPriceTypeRepository, IProductPriceTypeBusinessLogic>, IDatabaseValidationRules, ITermName, IEditable, IActive
    {
    	...
    	#region Constructors
    	public ProductPriceType() : this(default(IProductPriceTypeRepository), default(IProductPriceTypeBusinessLogic))
    	{
    	}
    	public ProductPriceType(IProductPriceTypeRepository repo) : this(repo, default(IProductPriceTypeBusinessLogic))
    	{
    	}
    	public ProductPriceType(IProductPriceTypeRepository repo, IProductPriceTypeBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<ProductPriceType> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<ProductPriceType> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<ProductPriceType> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var productPriceTypes = Repository.LoadAllFullWithSqlDependency();
    			foreach (var productPriceType in productPriceTypes)
    			{
    				productPriceType.StartTracking();
    				productPriceType.IsLazyLoadingEnabled = true;
    			}
