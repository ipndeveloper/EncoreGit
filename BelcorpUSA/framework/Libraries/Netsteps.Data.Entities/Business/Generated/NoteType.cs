...
{
    public partial class NoteType : EntityBusinessBase<NoteType, Int32, INoteTypeRepository, INoteTypeBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public NoteType() : this(default(INoteTypeRepository), default(INoteTypeBusinessLogic))
    	{
    	}
    	public NoteType(INoteTypeRepository repo) : this(repo, default(INoteTypeBusinessLogic))
    	{
    	}
    	public NoteType(INoteTypeRepository repo, INoteTypeBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<NoteType> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<NoteType> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<NoteType> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var noteTypes = Repository.LoadAllFullWithSqlDependency();
    			foreach (var noteType in noteTypes)
    			{
    				noteType.StartTracking();
    				noteType.IsLazyLoadingEnabled = true;
    			}
    			return noteTypes;
    		}
    		catch (Exception ex)
