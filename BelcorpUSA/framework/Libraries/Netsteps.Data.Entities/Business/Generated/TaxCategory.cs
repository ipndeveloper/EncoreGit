...
{
    public partial class TaxCategory : EntityBusinessBase<TaxCategory, Int32, ITaxCategoryRepository, ITaxCategoryBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public TaxCategory() : this(default(ITaxCategoryRepository), default(ITaxCategoryBusinessLogic))
    	{
    	}
    	public TaxCategory(ITaxCategoryRepository repo) : this(repo, default(ITaxCategoryBusinessLogic))
    	{
    	}
    	public TaxCategory(ITaxCategoryRepository repo, ITaxCategoryBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	{ 
    		...
    		this.ValidationRules.AddRule(CommonRules.StringMaxLength, new CommonRules.MaxLengthRuleArgs("IsDefault", 1));
    	...
    	public static List<TaxCategory> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<TaxCategory> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<TaxCategory> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var taxCategories = Repository.LoadAllFullWithSqlDependency();
    			foreach (var taxCategory in taxCategories)
    			{
    				taxCategory.StartTracking();
    				taxCategory.IsLazyLoadingEnabled = true;
    			}
