...
{
    public partial class PageType : EntityBusinessBase<PageType, Int16, IPageTypeRepository, IPageTypeBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public PageType() : this(default(IPageTypeRepository), default(IPageTypeBusinessLogic))
    	{
    	}
    	public PageType(IPageTypeRepository repo) : this(repo, default(IPageTypeBusinessLogic))
    	{
    	}
    	public PageType(IPageTypeRepository repo, IPageTypeBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<PageType> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<PageType> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<PageType> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var pageTypes = Repository.LoadAllFullWithSqlDependency();
    			foreach (var pageType in pageTypes)
    			{
    				pageType.StartTracking();
    				pageType.IsLazyLoadingEnabled = true;
    			}
    			return pageTypes;
    		}
    		catch (Exception ex)
