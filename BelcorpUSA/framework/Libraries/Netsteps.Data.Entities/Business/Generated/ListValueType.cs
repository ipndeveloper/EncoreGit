...
{
    public partial class ListValueType : EntityBusinessBase<ListValueType, Int16, IListValueTypeRepository, IListValueTypeBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public ListValueType() : this(default(IListValueTypeRepository), default(IListValueTypeBusinessLogic))
    	{
    	}
    	public ListValueType(IListValueTypeRepository repo) : this(repo, default(IListValueTypeBusinessLogic))
    	{
    	}
    	public ListValueType(IListValueTypeRepository repo, IListValueTypeBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<ListValueType> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<ListValueType> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<ListValueType> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var listValueTypes = Repository.LoadAllFullWithSqlDependency();
    			foreach (var listValueType in listValueTypes)
    			{
    				listValueType.StartTracking();
    				listValueType.IsLazyLoadingEnabled = true;
    			}
