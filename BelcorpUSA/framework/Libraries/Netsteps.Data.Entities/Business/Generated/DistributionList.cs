...
{
    public partial class DistributionList : EntityBusinessBase<DistributionList, Int32, IDistributionListRepository, IDistributionListBusinessLogic>, IDatabaseValidationRules, IActive
    {
    	...
    	#region Constructors
    	public DistributionList() : this(default(IDistributionListRepository), default(IDistributionListBusinessLogic))
    	{
    	}
    	public DistributionList(IDistributionListRepository repo) : this(repo, default(IDistributionListBusinessLogic))
    	{
    	}
    	public DistributionList(IDistributionListRepository repo, IDistributionListBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	{ 
    		this.ValidationRules.AddRule(CommonRules.GreaterThanValue<short>, new CommonRules.CompareValueRuleArgs<short>("DistributionListTypeID", 0));
