...
{
    public partial class StatisticValueType : EntityBusinessBase<StatisticValueType, Int16, IStatisticValueTypeRepository, IStatisticValueTypeBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public StatisticValueType() : this(default(IStatisticValueTypeRepository), default(IStatisticValueTypeBusinessLogic))
    	{
    	}
    	public StatisticValueType(IStatisticValueTypeRepository repo) : this(repo, default(IStatisticValueTypeBusinessLogic))
    	{
    	}
    	public StatisticValueType(IStatisticValueTypeRepository repo, IStatisticValueTypeBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<StatisticValueType> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<StatisticValueType> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<StatisticValueType> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var statisticValueTypes = Repository.LoadAllFullWithSqlDependency();
    			foreach (var statisticValueType in statisticValueTypes)
    			{
    				statisticValueType.StartTracking();
    				statisticValueType.IsLazyLoadingEnabled = true;
    			}
    			return statisticValueTypes;
    		}
    		catch (Exception ex)
    		{
    			throw EntityExceptionHelper.GetAndLogNetStepsException(ex, Constants.NetStepsExceptionType.NetStepsBusinessException);
