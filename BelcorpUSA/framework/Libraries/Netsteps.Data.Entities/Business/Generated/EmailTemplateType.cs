...
{
    public partial class EmailTemplateType : EntityBusinessBase<EmailTemplateType, Int16, IEmailTemplateTypeRepository, IEmailTemplateTypeBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public EmailTemplateType() : this(default(IEmailTemplateTypeRepository), default(IEmailTemplateTypeBusinessLogic))
    	{
    	}
    	public EmailTemplateType(IEmailTemplateTypeRepository repo) : this(repo, default(IEmailTemplateTypeBusinessLogic))
    	{
    	}
    	public EmailTemplateType(IEmailTemplateTypeRepository repo, IEmailTemplateTypeBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<EmailTemplateType> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<EmailTemplateType> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<EmailTemplateType> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var emailTemplateTypes = Repository.LoadAllFullWithSqlDependency();
    			foreach (var emailTemplateType in emailTemplateTypes)
    			{
    				emailTemplateType.StartTracking();
    				emailTemplateType.IsLazyLoadingEnabled = true;
    			}
