...
{
    public partial class ReplacementReason : EntityBusinessBase<ReplacementReason, Int32, IReplacementReasonRepository, IReplacementReasonBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public ReplacementReason() : this(default(IReplacementReasonRepository), default(IReplacementReasonBusinessLogic))
    	{
    	}
    	public ReplacementReason(IReplacementReasonRepository repo) : this(repo, default(IReplacementReasonBusinessLogic))
    	{
    	}
    	public ReplacementReason(IReplacementReasonRepository repo, IReplacementReasonBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<ReplacementReason> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<ReplacementReason> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<ReplacementReason> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var replacementReasons = Repository.LoadAllFullWithSqlDependency();
    			foreach (var replacementReason in replacementReasons)
    			{
    				replacementReason.StartTracking();
    				replacementReason.IsLazyLoadingEnabled = true;
    			}
