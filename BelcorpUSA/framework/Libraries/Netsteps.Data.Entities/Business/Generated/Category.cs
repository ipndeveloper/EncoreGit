...
{
    public partial class Category : EntityBusinessBase<Category, Int32, ICategoryRepository, ICategoryBusinessLogic>, IDatabaseValidationRules, ISortIndex
    {
    	...
    	#region Constructors
    	public Category() : this(default(ICategoryRepository), default(ICategoryBusinessLogic))
    	{
    	}
    	public Category(ICategoryRepository repo) : this(repo, default(ICategoryBusinessLogic))
    	{
    	}
    	public Category(ICategoryRepository repo, ICategoryBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	{ 
    		this.ValidationRules.AddRule(CommonRules.GreaterThanValue<short>, new CommonRules.CompareValueRuleArgs<short>("CategoryTypeID", 0));
    		this.ValidationRules.AddRule(CommonRules.StringMaxLength, new CommonRules.MaxLengthRuleArgs("CategoryNumber", 100));
