...
{
    public partial class StatisticType : EntityBusinessBase<StatisticType, Int16, IStatisticTypeRepository, IStatisticTypeBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public StatisticType() : this(default(IStatisticTypeRepository), default(IStatisticTypeBusinessLogic))
    	{
    	}
    	public StatisticType(IStatisticTypeRepository repo) : this(repo, default(IStatisticTypeBusinessLogic))
    	{
    	}
    	public StatisticType(IStatisticTypeRepository repo, IStatisticTypeBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<StatisticType> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<StatisticType> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<StatisticType> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var statisticTypes = Repository.LoadAllFullWithSqlDependency();
    			foreach (var statisticType in statisticTypes)
    			{
    				statisticType.StartTracking();
    				statisticType.IsLazyLoadingEnabled = true;
    			}
