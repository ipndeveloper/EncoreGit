...
{
    public partial class FileResourceType : EntityBusinessBase<FileResourceType, Int32, IFileResourceTypeRepository, IFileResourceTypeBusinessLogic>, IDatabaseValidationRules, ITermName, IEditable, IActive
    {
    	...
    	#region Constructors
    	public FileResourceType() : this(default(IFileResourceTypeRepository), default(IFileResourceTypeBusinessLogic))
    	{
    	}
    	public FileResourceType(IFileResourceTypeRepository repo) : this(repo, default(IFileResourceTypeBusinessLogic))
    	{
    	}
    	public FileResourceType(IFileResourceTypeRepository repo, IFileResourceTypeBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<FileResourceType> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<FileResourceType> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<FileResourceType> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var fileResourceTypes = Repository.LoadAllFullWithSqlDependency();
    			foreach (var fileResourceType in fileResourceTypes)
    			{
    				fileResourceType.StartTracking();
    				fileResourceType.IsLazyLoadingEnabled = true;
    			}
