...
{
    public partial class OrderShipmentPackage : EntityBusinessBase<OrderShipmentPackage, Int32, IOrderShipmentPackageRepository, IOrderShipmentPackageBusinessLogic>, IDatabaseValidationRules, IDateCreated, IDateLastModified
    {
    	...
    	#region Constructors
    	public OrderShipmentPackage() : this(default(IOrderShipmentPackageRepository), default(IOrderShipmentPackageBusinessLogic))
    	{
    	}
    	public OrderShipmentPackage(IOrderShipmentPackageRepository repo) : this(repo, default(IOrderShipmentPackageBusinessLogic))
    	{
    	}
    	public OrderShipmentPackage(IOrderShipmentPackageRepository repo, IOrderShipmentPackageBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	{ 
    		this.ValidationRules.AddRule(CommonRules.GreaterThanValue<int>, new CommonRules.CompareValueRuleArgs<int>("OrderShipmentID", 0));
    		this.ValidationRules.AddRule(CommonRules.StringMaxLength, new CommonRules.MaxLengthRuleArgs("TrackingNumber", 50));
    		this.ValidationRules.AddRule(CommonRules.GreaterThanValue<System.DateTime>, new CommonRules.CompareValueRuleArgs<System.DateTime>("DateShippedUTC", new DateTime(1753, 1, 1), Translation.GetTerm("InvalidDateTimeMinErrorMessageWithValue", CustomValidationMessages.DateTimeMinWithValue)));
