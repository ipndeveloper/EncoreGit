...
{
    public partial class CampaignOptOut : EntityBusinessBase<CampaignOptOut, Int32, ICampaignOptOutRepository, ICampaignOptOutBusinessLogic>, IDatabaseValidationRules
    {
    	...
    	#region Constructors
    	public CampaignOptOut() : this(default(ICampaignOptOutRepository), default(ICampaignOptOutBusinessLogic))
    	{
    	}
    	public CampaignOptOut(ICampaignOptOutRepository repo) : this(repo, default(ICampaignOptOutBusinessLogic))
    	{
    	}
    	public CampaignOptOut(ICampaignOptOutRepository repo, ICampaignOptOutBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
