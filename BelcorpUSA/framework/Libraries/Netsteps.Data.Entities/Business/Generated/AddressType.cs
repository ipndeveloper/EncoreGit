...
{
    public partial class AddressType : EntityBusinessBase<AddressType, Int16, IAddressTypeRepository, IAddressTypeBusinessLogic>, IDatabaseValidationRules, ITermName, IActive
    {
    	...
    	#region Constructors
    	public AddressType() : this(default(IAddressTypeRepository), default(IAddressTypeBusinessLogic))
    	{
    	}
    	public AddressType(IAddressTypeRepository repo) : this(repo, default(IAddressTypeBusinessLogic))
    	{
    	}
    	public AddressType(IAddressTypeRepository repo, IAddressTypeBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	public static List<AddressType> LoadAll()
    	{
    		try
    		{
    	...
    	// Generated for the "small collection" tables. - JHE
    	public static List<AddressType> LoadAllFull()
    	{
    		try
    		{
    	...
    	public static SqlUpdatableList<AddressType> LoadAllFullWithSqlDependency()
    	{
    		try
    		{
    			var addressTypes = Repository.LoadAllFullWithSqlDependency();
    			foreach (var addressType in addressTypes)
    			{
    				addressType.StartTracking();
    				addressType.IsLazyLoadingEnabled = true;
    			}
    			return addressTypes;
    		}
    		catch (Exception ex)
