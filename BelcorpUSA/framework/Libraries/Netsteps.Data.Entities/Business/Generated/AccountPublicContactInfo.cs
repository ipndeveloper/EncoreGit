...
{
    public partial class AccountPublicContactInfo : EntityBusinessBase<AccountPublicContactInfo, Int32, IAccountPublicContactInfoRepository, IAccountPublicContactInfoBusinessLogic>, IDatabaseValidationRules, IModifiedByUserID, IDataVersion
    {
    	...
    	#region Constructors
    	public AccountPublicContactInfo() : this(default(IAccountPublicContactInfoRepository), default(IAccountPublicContactInfoBusinessLogic))
    	{
    	}
    	public AccountPublicContactInfo(IAccountPublicContactInfoRepository repo) : this(repo, default(IAccountPublicContactInfoBusinessLogic))
    	{
    	}
    	public AccountPublicContactInfo(IAccountPublicContactInfoRepository repo, IAccountPublicContactInfoBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	{ 
    		...
    		this.ValidationRules.AddRule(CommonRules.StringMaxLength, new CommonRules.MaxLengthRuleArgs("PhoneNumber", 100));
    		...
    		this.ValidationRules.AddRule(CommonRules.StringMaxLength, new CommonRules.MaxLengthRuleArgs("Title", 320));
