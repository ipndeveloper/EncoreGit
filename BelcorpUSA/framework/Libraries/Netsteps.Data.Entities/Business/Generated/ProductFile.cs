...
{
    public partial class ProductFile : EntityBusinessBase<ProductFile, Int32, IProductFileRepository, IProductFileBusinessLogic>, IDatabaseValidationRules, IModifiedByUserID, ISortIndex
    {
    	...
    	#region Constructors
    	public ProductFile() : this(default(IProductFileRepository), default(IProductFileBusinessLogic))
    	{
    	}
    	public ProductFile(IProductFileRepository repo) : this(repo, default(IProductFileBusinessLogic))
    	{
    	}
    	public ProductFile(IProductFileRepository repo, IProductFileBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
    	...
    	{ 
    		this.ValidationRules.AddRule(CommonRules.GreaterThanValue<int>, new CommonRules.CompareValueRuleArgs<int>("ProductFileTypeID", 0));
    		...
    		this.ValidationRules.AddRule(CommonRules.NotNull, new ValidationRuleArgs("FilePath"));
