...
{
    public partial class AutoshipBatch : EntityBusinessBase<AutoshipBatch, Int32, IAutoshipBatchRepository, IAutoshipBatchBusinessLogic>, IDatabaseValidationRules, IDateRange
    {
    	...
    	#region Constructors
    	public AutoshipBatch() : this(default(IAutoshipBatchRepository), default(IAutoshipBatchBusinessLogic))
    	{
    	}
    	public AutoshipBatch(IAutoshipBatchRepository repo) : this(repo, default(IAutoshipBatchBusinessLogic))
    	{
    	}
    	public AutoshipBatch(IAutoshipBatchRepository repo, IAutoshipBatchBusinessLogic logic)
    		: base(repo, logic)
    	{
    		InitializeEntity();
    	}
