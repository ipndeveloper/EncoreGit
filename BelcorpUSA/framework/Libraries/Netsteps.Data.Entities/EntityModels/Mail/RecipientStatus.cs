...
namespace NetSteps.Data.Entities.Mail
{
    ...
    [Serializable]
    public partial class RecipientStatus: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region Primitive Properties
    
        public short RecipientStatusID
        {
            ...
            set
            {
                if (_recipientStatusID != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'RecipientStatusID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        private short _recipientStatusID;
        ...
        private void FixupMailMessageGroupAddresses(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.RecipientStatus, this))
                    {
                        item.RecipientStatus = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
