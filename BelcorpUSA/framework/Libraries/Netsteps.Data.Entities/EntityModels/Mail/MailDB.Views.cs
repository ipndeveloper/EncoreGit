...
[assembly: System.Data.Mapping.EntityViewGenerationAttribute(typeof(Edm_EntityMappingGeneratedViews.ViewsForBaseEntitySets0E383D587A49AF702AB5372075AD204485E04435974D5B5E25D9C98FEDFCA88A))]
...
namespace Edm_EntityMappingGeneratedViews
{
    ...
    /// </Summary>
    public sealed class ViewsForBaseEntitySets0E383D587A49AF702AB5372075AD204485E04435974D5B5E25D9C98FEDFCA88A : System.Data.Mapping.EntityViewContainer
    {
        
        /// <Summary>
        /// The constructor stores the views for the extents and also the hash values generated based on the metadata and mapping closure and views.
        /// </Summary>
        public ViewsForBaseEntitySets0E383D587A49AF702AB5372075AD204485E04435974D5B5E25D9C98FEDFCA88A()
        {
            this.EdmEntityContainerName = "MailEntities";
            this.StoreEntityContainerName = "NSFramework_Mail_TestModelStoreContainer";
            this.HashOverMappingClosure = "b62f1be617ccc80ce89ef8691874de5e133bebcb4ba655013055ac0fea3d5f61";
            this.HashOverAllExtentViews = "f6c0c294eac9723079406a60fd88b6e5f28dcfb6df1cd3ed666ae80a1bd9ad0b";
            this.ViewCount = 34;
        }
    ...
    FROM (
        ...
        private System.Collections.Generic.KeyValuePair<string, string> GetView11()
        {
            return new System.Collections.Generic.KeyValuePair<string, string>("NSFramework_Mail_TestModelStoreContainer.MailMessages", "\r\n    SELECT VALUE -- Constructing MailMessages\r\n        [NSFramework_Mail_TestMo" +
                    ...
                    ", T1.MailMessages_EnableEventTracking)\r\n    FROM (\r\n        SELECT \r\n           " +
                    " T.MailMessageID AS MailMessages_MailMessageID, \r\n            T.Subject AS MailM" +
                    "essages_Subject, \r\n            T.Body AS MailMessages_Body, \r\n            T.HTML" +
                    "Body AS MailMessages_HTMLBody, \r\n            T.DateAddedUTC AS MailMessages_Date" +
                    "AddedUTC, \r\n            T.FromAddress AS MailMessages_FromAddress, \r\n           " +
                    " T.FromNickName AS MailMessages_FromNickName, \r\n            T.MailAccountID AS M" +
                    "ailMessages_MailAccountID, \r\n            T.IsOutbound AS MailMessages_IsOutbound" +
                    ", \r\n            T.MailMessageTypeID AS MailMessages_MailMessageTypeID, \r\n       " +
                    "     T.BeenRead AS MailMessages_BeenRead, \r\n            T.MailMessagePriorityID " +
                    "AS MailMessages_MailMessagePriorityID, \r\n            T.VisualTemplateID AS MailM" +
                    "essages_VisualTemplateID, \r\n            T.MailFolderTypeID AS MailMessages_MailF" +
                    "olderTypeID, \r\n            T.AttachmentUniqueID AS MailMessages_AttachmentUnique" +
                    "ID, \r\n            T.Locked AS MailMessages_Locked, \r\n            T.SiteID AS Mai" +
                    "lMessages_SiteID, \r\n            T.CampaignActionID AS MailMessages_CampaignActio" +
                    "nID, \r\n            T.EnableEventTracking AS MailMessages_EnableEventTracking, \r\n" +
                    "            True AS _from0\r\n        FROM MailEntities.MailMessages AS T\r\n    ) A" +
                    "S T1");
        }
    ...
    FROM (
        ...
        private System.Collections.Generic.KeyValuePair<string, string> GetView17()
        {
            return new System.Collections.Generic.KeyValuePair<string, string>("MailEntities.MailMessages", "\r\n    SELECT VALUE -- Constructing MailMessages\r\n        [NSFramework_Mail_TestMo" +
                    ...
                    "entTracking)\r\n    FROM (\r\n        SELECT \r\n            T.MailMessageID AS MailMe" +
                    "ssage_MailMessageID, \r\n            T.Subject AS MailMessage_Subject, \r\n         " +
                    "   T.Body AS MailMessage_Body, \r\n            T.HTMLBody AS MailMessage_HTMLBody," +
                    " \r\n            T.FromAddress AS MailMessage_FromAddress, \r\n            T.FromNic" +
                    "kName AS MailMessage_FromNickName, \r\n            T.MailAccountID AS MailMessage_" +
                    "MailAccountID, \r\n            T.IsOutbound AS MailMessage_IsOutbound, \r\n         " +
                    "   T.MailMessageTypeID AS MailMessage_MailMessageTypeID, \r\n            T.BeenRea" +
                    "d AS MailMessage_BeenRead, \r\n            T.MailMessagePriorityID AS MailMessage_" +
                    "MailMessagePriorityID, \r\n            T.VisualTemplateID AS MailMessage_VisualTem" +
                    "plateID, \r\n            T.MailFolderTypeID AS MailMessage_MailFolderTypeID, \r\n   " +
                    "         T.AttachmentUniqueID AS MailMessage_AttachmentUniqueID, \r\n            T" +
                    ".Locked AS MailMessage_Locked, \r\n            T.SiteID AS MailMessage_SiteID, \r\n " +
                    "           T.DateAddedUTC AS MailMessage_DateAddedUTC, \r\n            T.CampaignA" +
                    "ctionID AS MailMessage_CampaignActionID, \r\n            T.EnableEventTracking AS " +
                    "MailMessage_EnableEventTracking, \r\n            True AS _from0\r\n        FROM NSFr" +
                    "amework_Mail_TestModelStoreContainer.MailMessages AS T\r\n    ) AS T1");
        }
