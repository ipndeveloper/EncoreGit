...
namespace NetSteps.Data.Entities.Mail
{
    ...
    [Serializable]
    public partial class MailFolderType: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public short MailFolderTypeID
        {
            ...
            set
            {
                if (_mailFolderTypeID != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'MailFolderTypeID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        private void FixupMailMessages(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.MailFolderType, this))
                    {
                        item.MailFolderType = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
