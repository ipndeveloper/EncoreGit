...
namespace NetSteps.Data.Entities.Mail
{
    ...
    [Serializable]
    public partial class RecipientType: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region Primitive Properties
    
        public short RecipientTypeID
        {
            ...
            set
            {
                if (_recipientTypeID != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'RecipientTypeID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        private short _recipientTypeID;
        ...
        private void FixupMailMessageGroupAddresses(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.RecipientType, this))
                    {
                        item.RecipientType = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
