...
namespace NetSteps.Web.Mvc.ActionResults
{
    ...
    public class CsvExport
    {
        ...
        /// </param>
        public CsvExport(string columnSeparator = ",", bool includeColumnSeparatorDefinitionPreamble = true, string head="", string foot="")
        {
        ...
        {
            //The header
            yield return headCSV;

            //if (_includeColumnSeparatorDefinitionPreamble) "sep=" + _columnSeparator;
