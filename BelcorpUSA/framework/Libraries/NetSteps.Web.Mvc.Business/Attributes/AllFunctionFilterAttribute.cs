...
namespace NetSteps.Web.Mvc.Attributes
{
	...
	public class AllFunctionFilterAttribute : FunctionFilterAttribute
	{
		...
		public AllFunctionFilterAttribute(string redirectUrl, Constants.SiteType siteTypeID = Data.Entities.Generated.ConstantsGenerated.SiteType.NotSet, params string[] functions)
