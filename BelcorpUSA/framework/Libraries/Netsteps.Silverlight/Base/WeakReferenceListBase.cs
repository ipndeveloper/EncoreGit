...
namespace NetSteps.Silverlight.Base
{
    ...
    /// Author: John Egbert
    /// Created: 12/14/2009
    /// List of classes by weak reference to not prevent them from being Garbage collected - JHE
    /// </summary>
    public class WeakReferenceListBase<T> : ThreadSafeList<WeakReferenceObject<T>> where T : class
    {
        #region Members
        #endregion
