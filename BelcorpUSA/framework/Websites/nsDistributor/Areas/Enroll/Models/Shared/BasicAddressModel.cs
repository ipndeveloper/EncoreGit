    ...
    public class BasicAddressModel : IValidatableObject
    {
            ...
            bool isVisible = true)
        {
            ...
            if (address.AddressID > 0)
                street = AccountPropertiesBusinessLogic.GetValueByID(9, address.AddressID).Street;
            ...
            this.StateProvinceID = address.State;
        ...
        public virtual BasicAddressModel ApplyTo(Address address)
        {
            ...
            address.SetState(this.StateProvinceID, this.CountryID);/*CS.Cambio*/
