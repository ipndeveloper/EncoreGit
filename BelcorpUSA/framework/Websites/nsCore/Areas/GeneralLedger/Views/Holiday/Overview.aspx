...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="SectionHeader">
        <h2>
            <%= Html.Term("HolidayCalendarUpdate", "Update Holiday")%></h2>
    ...
    <% using (Html.BeginForm("Update", "Holiday", FormMethod.Post, new { id = "frmHolidayAddNew" }))
       {
    ...
    <table class="FormTable" width="40%">
        <tr>
            <td>
                <%= Html.TextBoxFor(m => m.Holiday.HolidayID, new { @id = "txtHiddenId", @style = "display: none;" })%>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                <%= Html.DropDownListFor(m => m.Holiday.StateID, new SelectList(Model.StateProvinces, "StateProvinceID", "Name"))%>
        ...
        <tr>
            ...
            <td>
                <%= Html.TextBoxFor(m => m.dateHidden, new {@id="dateHoliday", @class = "DatePicker TextInput" })%>
                <div id="msjDate" style="display: none;">
                    <p><small style="color: Red;">Select a Date</small></p>
                </div>
            ...
            <td>
                <p>
                    <input type="button" id="btnSave" onclick="return validarCampos();" style="display: inline-block;
                        cursor: pointer;" class="Button BigBlue" value="Update Holiday" />
