        ...
        <tr>
            ...
            <td>
               <%-- <select id="ddlPaymentType">
                  ...
                  value="<%=Model[0].ProcessOnDateUTC  %>"  /><br />
  ...
  <script type="text/javascript">
    ...
    $(function () {
        ...
        $('#ddlEntity').change(function () {
            ...
            showLoading(t);
            $.get('<%= ResolveUrl(string.Format("~/GeneralLedger/PaymentTickets/GetPaymentTypes/")) %>', { BanckID: BanckID }, function (response) {
                if (response.result) {
                    hideLoading(t);
         ...
         var fechaInvalida=false;
          ...
          if (processOnDateUTC != '')
          {
            ...
            showLoading(t);
                $.get('<%= ResolveUrl(string.Format("~/GeneralLedger/PaymentTickets/GetApplyManualPayment/")) %>', { TicketNumber: TicketNumber, BankID: bankID ,ProcessOnDateUTC: processOnDateUTC}, function (response) {
                    if (response.result) {
                        hideLoading(t);
