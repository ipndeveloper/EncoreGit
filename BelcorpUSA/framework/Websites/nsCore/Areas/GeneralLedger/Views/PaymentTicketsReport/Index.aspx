<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/GeneralLedger/Views/Shared/GeneralLedger.Master"
        ...
        $(function () {
            ...
            $("#btnSearchTicket").click(function () {
               ...
               // ExpirationDateHasta = (isNaN(ExpirationDateHasta) || $.trim(ExpirationDateHasta) == "") ? "" : ExpirationDateHasta
                ...
                window.location = '<%= ResolveUrl("~/GeneralLedger/PaymentTicketsReport/BrowseTickets/") %>' + query
            });
