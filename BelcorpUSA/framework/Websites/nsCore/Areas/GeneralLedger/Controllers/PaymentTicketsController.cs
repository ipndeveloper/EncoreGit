            ...
            try
            {
                ...
                foreach (var controlLog in ControlLogs)
                {
                    ...
                    builder
                        ...
                        .AppendCell(controlLog.InitialAmount.ToString("N"))
                        .AppendCell(controlLog.InterestAmount.ToString("N"))
                        .AppendCell(controlLog.FineAmount.ToString("N"))
                        .AppendCell(controlLog.TotalAmount.ToString("N"))
        ...
        public virtual ActionResult GeListRenegotiationShares(string TicketNumber, string RenegotiationConfigurationID, string NegotiationLevelID)
        {
            try
            {
                ...
                return Json(new
                {
                    ...
                    NumShared = FormtDec(data.NumShared),
