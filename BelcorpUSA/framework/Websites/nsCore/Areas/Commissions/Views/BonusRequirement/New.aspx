<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/Commissions/Views/Shared/Commissions.Master" Inherits="System.Web.Mvc.ViewPage<NetSteps.Data.Entities.Business.BonusRequirement>" %>
<asp:Content ID="Content2" ContentPlaceHolderID="LeftNav" runat="server">    
    <div class="SectionNav">
        <ul class="SectionLinks">
            <%= Html.SelectedLink("~/Commissions/BonusRequirement/", Html.Term("Browse", "Browse Commission Rules"), LinkSelectionType.SubDirectory, CoreContext.CurrentUser, "")%>                
        </ul>
    </div>    
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="BreadCrumbContent" runat="server">
  <a href="<%= ResolveUrl("~/Commissions/BonusRequirement") %>">
    ...
    <%= Html.Term("NewBonusRequirement", "New Bonus Requirement")%>
</asp:Content>
