<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/Commissions/Views/Shared/Commissions.Master" Inherits="System.Web.Mvc.ViewPage<nsCore.Areas.Commissions.Models.PublishModel>" %>
    ...
    <div class="Content">
        <table width="100%">
            <tr>
                <td style="padding: 10px; width: 40%" id="RunSettings" rowspan="2">
                    ...
                    <table class="DataGrid">
                        ...
                        <tr>
                            <td colspan="2">
                                <p>   
                                    <a id="btnPublish" href="javascript:void(0);" class="Button allowDisable" style="display: block; text-align: center; width: 150px;">
                                        <span><%= Html.Term("PublishToLive", "Publish to Live") %></span>
                                    </a>                                  
                                </p>                                
                            </td>
                        </tr>
                ...
                <td style="padding: 10px; width: 60%" id="RunStatusColumn">
