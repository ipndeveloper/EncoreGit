...
<div class="pad5 promotionOption AccountIDs">
    ...
    <div rel="isYes" class="hasPanel" id="accountIDs">
	    ...
	    <div class="UI-lightBg hiddenPanel pad10 overflow" id="AccountIDsSelection" >
            ...
            <span class="lawyer">
			    <%=Html.Term("PromotionOptions_RestrictToAccountIDs", "Only the accounts on this list will receive the promotion.")%>
		    </span>
					    ...
					    <td>
						    ...
						    <table width="100%" class="DataGrid" id="accountIDsGrid">
							    ...
							    <tbody>
                                    ...
                                    <tr>
									    <td>
										    <input type="checkbox" class="selectRow"><input type="hidden" class="accountId" value="65834">
									    </td>
									    <td>
										    65834
									    </td>
								    ...
								    <tr>
									    <td>
										    <input type="checkbox" class="selectRow"><input type="hidden" class="accountId" value="65866">
									    </td>
									    <td>
										    65866
									    </td>
								    ...
								    <tr>
									    <td>
										    <input type="checkbox" class="selectRow"><input type="hidden" class="accountId" value="65873">
									    </td>
									    <td>
										    65873
									    </td>
								    ...
								    <tr>
									    <td>
										    <input type="checkbox" class="selectRow"><input type="hidden" class="accountId" value="65874">
									    </td>
									    <td>
										    65874
									    </td>
