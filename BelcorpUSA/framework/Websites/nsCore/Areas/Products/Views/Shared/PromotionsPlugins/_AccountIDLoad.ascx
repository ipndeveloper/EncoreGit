...
<script type="text/javascript">
	<% 
	string radioID = Model.HasAccountIDs ? "#acctIDsY" : "#acctIDsN";  
	%>
	$(function () { 
...
<div class="pad5 promotionOption AccountIDs">
    ...
    <div rel="isYes" class="hasPanel" id="accountIDs">
        ...
        <div <%= Model.HasAccountIDs?"":"style=\"display: none;\"" %> class="UI-lightBg hiddenPanel pad10 overflow"
            id="AccountIDsSelection">
                        ...
                        <td>
                            ...
                            <table width="100%" class="DataGrid" id="accountIDsGrid">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <input type="checkbox" class="selectRow" /><input type="hidden" class="accountId"
