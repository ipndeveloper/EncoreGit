<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<nsCore.Areas.Products.Models.Promotions.FlatDiscountPromotionModel>" %>

<% Html.RenderPartial("_EditScriptPriceAdjustmentFlat"); %>
...
<% Html.RenderPartial("PromotionsPlugins/_PromotionItems", Model.PromotionProducts); %>
