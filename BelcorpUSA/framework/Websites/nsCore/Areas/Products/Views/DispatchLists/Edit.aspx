...
Inherits="System.Web.Mvc.ViewPage<nsCore.Areas.Products.Models.DispatchListsModel>" %>
        ...
        $(function () {
            ...
            $('#btnSave').click(function () {
               ...
               $("#conditionSingleGrid tbody tr").each(function (index) {
                ...
                var url = '<%= ResolveUrl("~/Products/DispatchLists/Update") %>';
...
<asp:Content ID="Content1" ContentPlaceHolderID="BreadCrumbContent" runat="server">
    ...
    <%= Html.Term("EditDispatchList", "Edit Dispatch List")%>
</asp:Content>
 
 
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
  <div class="SectionHeader">
    <h2><%= Html.Term("EditListDispatch", "Edit List Dispatch")%>
    </h2>
  </div>
...
<table class="FormTable" width="100%">
    <tr> 
       ...
       <td>
        <input type="text" id="nameDispatchList" value="<%=Model.Name %>" style="width: 300px;" />
       </td>
       <td>
        ...
        <div>
            <table width="100%" class="DataGrid" id="conditionSingleGrid">
	                ...
	                {%>
		              <tr>
                      <td><a class="BtnDelete" href="javascript:void(0);"><span class="Delete icon-x"></span></a>
                         <input type="hidden" id="account" class="productId required" name="Product is required" value="' + <%=item.AccountNumber %> + '" />
                      </td> 
