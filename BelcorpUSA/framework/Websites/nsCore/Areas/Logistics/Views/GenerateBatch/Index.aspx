...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            //            $('#WarehouseIDInputFilter')
            //                .removeClass('Filter')
            //                .watermark('<%= Html.JavascriptTerm("WarehouseSearch", "Look up Ware house by ID or Name") %>')
            //                .jsonSuggest('<%= ResolveUrl("~/Logistics/GenerateBatch/WarehouseSearch") %>',
            //                    {
            //                        onSelect: function (item) {
            //                            $('#WarehouseIDInputFilter').val(item.text);


            //                            ObjIds["WarehouseID"] = item.id;
            //                            $("#idsInputFilter").val(JSON.stringify(ObjIds));
        ...
        function generarProceso() {
            var url = '<%= ResolveUrl("~/Logistics/GenerateBatch/InsertarOrderInvoiceItem") %>';
            var chkreprocess = $("#chkreprocess").is(":checked")
            ...
            var data = JSON.stringify({
                LstOrderCustomer: ArrInsertar,
                Reprocesse: chkreprocess
            });
        ...
        function ModoReproceso(ctr) {
            ObjIds.Reprocess = $(ctr).is(":checked") ? 1 : 0;
            $("#idsInputFilter").val(JSON.stringify(ObjIds));

            $.SetParamSearchGridView("parametroAdicional", 3);
...
<asp:Content ID="Content3" ContentPlaceHolderID="BreadCrumbContent" runat="server">
    <%
        ...
        Dictionary<int, string> dcShowGenerated = (ViewBag.ShowGenerated as Dictionary<int, string>) ?? new Dictionary<int, string>();
    ...
    %>
    <% Html.PaginatedGrid<OrderToBatch>("~/Logistics/GenerateBatch/ConsultaGenerateBillingProcess")
        //   .AutoGenerateColumns()
        //.HideClientSpecificColumns_()
                ...
                .AddSelectFilter(Html.Term("ShowGenerated", "Show Generated"), "ShowGenerated", new Dictionary<int, string>() { { 3, Html.Term("SelectItem", "Select Item") } }.AddRange(dcShowGenerated))
                /*CS.19AG2016.Ininio.Nuevo Filtro */
           ...
           //.AddSelectFilter(Html.Term("WarehousePrinte", "Warehouse Printe"), "WarehousePrinterID", new Dictionary<int, string>() { { 0, Html.Term("SelectItem", "Select Item") } }.AddRange(dcListWarehousePrinters))
                ...
                .AddColumn(Html.Term("BatchGenerated", "Batch Generated"), "BatchGenerated")
    ...
    <table style="width: 100%">
        ...
        <tr>
            ...
            <td style="width: 30%">
                <%--<label for="chkreprocess">
                    <%=Html.Term("Reprocess", "Reprocess")%></label>
                <input type="checkbox" onchange="ModoReproceso(this)" id="chkreprocess" />--%>
            </td>
        </tr>
    </table>
