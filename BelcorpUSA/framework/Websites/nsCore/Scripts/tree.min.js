...
(function ($) {
    ...
    function tree_component() {
        return {
            ...
            select_branch: function (obj, multiple) {
                ...
                this.callback("onselect", [o, _this]);
                this.callback("onchange", [o, _this]);
            },
    ...
    $(function () {
        ...
        //alert($('.CategoryTree li').css('line-height') + ', ' + $('.CategoryTree li').css('font-size') + ', ' + $('.CategoryTree li a').css('line-height') + ', ' + $('.CategoryTree li a').css('font-size') + ', ' + $('.CategoryTree ul').css('line-height'));
        var css = '/* TREE LAYOUT */ .tree ul { margin:0 0 0 5px; padding:0 0 0 0; list-style-type:none; } .tree li { display:block;padding:0 0 0 15px; margin:0 0 0 0; /* Background fix */ clear:both; } .tree li ul { display:none; } .tree li a, .tree li span { display:inline-block;color:black;white-space:nowrap;text-decoration:none;padding:0 4px;margin:0; } .tree li a:focus { outline: none; } .tree li a input, .tree li span input { margin:0;padding:0 0;display:inline-block;height:12px !important;border:1px solid white;background:white;font-size:10px;font-family:Verdana; } .tree li a input:not([class="xxx"]), .tree li span input:not([class="xxx"]) { padding:1px 0; } /* FOR DOTS */ .tree .ltr li.last { float:left; } .tree > ul li.last { overflow:visible; } /* OPEN OR CLOSE */ .tree li.open ul { display:block; } .tree li.closed ul { display:none !important; } /* FOR DRAGGING */ #jstree-dragged { position:absolute; top:-10px; left:-10px; margin:0; padding:0; } #jstree-dragged ul ul ul { display:none; } #jstree-marker { padding:0; margin:0; line-height:5px; font-size:1px; overflow:hidden; height:5px; position:absolute; left:-45px; top:-30px; z-index:1000; background-color:transparent; background-repeat:no-repeat; display:none; } #jstree-marker.marker { width:45px; background-position:-32px top; } #jstree-marker.marker_plus { width:5px; background-position:right top; } /* BACKGROUND DOTS */ .tree li li { overflow:hidden; } .tree > .ltr > li { display:table; } /* ICONS */ .tree ul ins { display:inline-block; text-decoration:none; width:16px; height:16px; } .tree .ltr ins { margin:0 4px 0 0px; } ';
        if ($.browser.msie) {
            ...
            if ($.browser.version == 7) css += '.tree li a {float:left;} .tree li li { overflow:visible; } .tree .ltr li.last { margin-top: expression( (this.previousSibling && /open/.test(this.previousSibling.className) ) ? "-2px" : "0"); }';
            if ($.browser.version == 8) css += '.tree li { line-height:.8em; }';
            if ($.browser.version == 9) css += '.tree li { line-height:.09em; }';
        }
        ...
        if ($.browser.mozilla || $.browser.opera) css += '.tree li { line-height:.091em; }';
