...
{
    public class PaymentTicketCampaignEmailSender : CampaignEmailSender
    {
        ...
        public PaymentTicketCampaignEmailSender(DomainEventQueueItem domainEventQueueItem, EmailCampaignAction emailCampaignAction)
