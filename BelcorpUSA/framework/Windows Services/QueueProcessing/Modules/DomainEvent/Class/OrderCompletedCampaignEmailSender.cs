...
{
    public class OrderCompletedCampaignEmailSender : CampaignEmailSender
    {
        ...
        public OrderCompletedCampaignEmailSender(DomainEventQueueItem domainEventQueueItem, EmailCampaignAction emailCampaignAction)
        ...
        {
            return new OrderCompletedTokenValueProvider(_order);
        }
    }
}
