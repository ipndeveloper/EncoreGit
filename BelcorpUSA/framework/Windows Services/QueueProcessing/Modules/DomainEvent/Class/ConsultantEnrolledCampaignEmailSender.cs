...
{
	public class ConsultantEnrolledCampaignEmailSender : CampaignEmailSender
	{
		...
		public ConsultantEnrolledCampaignEmailSender(DomainEventQueueItem domainEventQueueItem, EmailCampaignAction emailCampaignAction)
		...
		private void InitializeMembers(DomainEventQueueItem domainEventQueueItem)
		{
			if (domainEventQueueItem.EventContext != null && domainEventQueueItem.EventContext.AccountID != null)
			{
                ...
                if ((NewAccount.User) == null && NewAccount.UserID.GetValueOrDefault() > 0)
                {
                    NewAccountUser = NewAccount.User;
