...
[assembly: Wireup(typeof(NetSteps.QueueProcessing.Modules.CampaignActionQueueItem.ModuleWireup))]
...
namespace NetSteps.QueueProcessing.Modules.CampaignActionQueueItem
{
    ...
    public class ModuleWireup : WireupCommand
    {
        ...
        protected override void PerformWireup(IWireupCoordinator coordinator)
        {
            ...
            root.ForType<CampaignActionQueueItemProcessor>()
               .Register<CampaignActionQueueItemProcessor>()
               .End();

            IQueueProcessorRegistry registry = Create.New<IQueueProcessorRegistry>();
            registry.Register<CampaignActionQueueItemProcessor>(CampaignActionQueueItemProcessor.CProcessorName);
        }
    }
}