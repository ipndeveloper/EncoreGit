...
[assembly: Wireup(typeof(NetSteps.QueueProcessing.Modules.DeviceNotification.ModuleWireup))]
...
namespace NetSteps.QueueProcessing.Modules.DeviceNotification
{
    ...
    public class ModuleWireup : WireupCommand
    {
        ...
        protected override void PerformWireup(IWireupCoordinator coordinator)
        {
            ...
            root.ForType<DeviceNotificationQueueProcessor>()
               .Register<DeviceNotificationQueueProcessor>()
               .End();

            IQueueProcessorRegistry registry = Create.New<IQueueProcessorRegistry>();
            registry.Register<DeviceNotificationQueueProcessor>(DeviceNotificationQueueProcessor.CProcessorName);
        }
    }
}