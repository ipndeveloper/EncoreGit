...
[assembly: Wireup(typeof(NetSteps.QueueProcessing.Modules.CampaignAction.ModuleWireup))]
...
namespace NetSteps.QueueProcessing.Modules.CampaignAction
{
    ...
    public class ModuleWireup : WireupCommand
    {
        ...
        protected override void PerformWireup(IWireupCoordinator coordinator)
        {
            ...
            root.ForType<CampaignActionProcessor>()
               .Register<CampaignActionProcessor>()
               .End();

            IQueueProcessorRegistry registry = Create.New<IQueueProcessorRegistry>();
            registry.Register<CampaignActionProcessor>(CampaignActionProcessor.CProcessorName);
        }
    }
}